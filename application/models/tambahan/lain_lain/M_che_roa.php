...
class M_che_roa extends CI_Model {
                        ...
                        if ($q3->num_rows() > 0) {
                            foreach ($q3->result() as $row3) {
                                $q4 = $this->db1->query("select distinct(formkd), formnm ,max(formjudul) as formjudul,
                                                    ...
                                                    from vwmst_form h where h.formjnsnm = '".$row->formjnsnm."' and h.formkategorinm = '".$row2->formkategorinm."' and h.formkategori2nm = '".$row3->formkategori2nm."'
