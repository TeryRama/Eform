<?php
class M_formfrmfss812_01 extends CI_Model
{

    var $tabel1 = 'tblfrmfrmfss812hdr';
    var $tabel2 = 'tblfrmfrmfss812dtl';
    var $tabel3 = 'tblfrmfrmfss812dtlx';
    ...
    function get_akumulasi_operasi($dept, $id_jns_mesin, $id_gugus, $create_date)
    {
        return $this->db1->query("select 
                                        '$create_date'::date as create_date,
                                        b.nama_mesin,
                                        b.kode_mesin,
                                        sum(coalesce(nullif(jam_operasi,''), '0')::numeric) akumulasi_operasi
                                    from 
                                        tblfrmfrmfss812hdr as a 
                                    left join
                                        tblfrmfrmfss812dtl as b
                                        on a.headerid = b.headerid
                                    where
                                        a.deptabbr = '$dept'
                                        and a.id_jns_mesin = '$id_jns_mesin'
                                        and a.id_gugus = '$id_gugus'
                                        and a.create_date>=to_date('$create_date', 'yyyy-01-01')
