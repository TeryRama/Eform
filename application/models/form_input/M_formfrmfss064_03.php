<?php
class M_formfrmfss064_03 extends CI_Model
{

    var $tabel1 = 'tblfrmfrmfss064hdr';
    var $tabel2 = 'tblfrmfrmfss064dtl';
    var $tabel3 = 'tblfrmfrmfss064dtlx';
    ...
    function check($create_date, $docno, $rev, $dept, $deptabbr)
    {
        $this->db1->from($this->tabel1);
    ...
    function check2($create_date, $docno, $rev, $dept, $deptabbr, $headerid)
    {
        $this->db1->from($this->tabel1);
        $this->db1->where('create_date', $create_date);
