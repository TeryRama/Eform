...
class M_formfrmfss318_10 extends CI_Model
{
    ...
    {
        $this->db1->select('*, row_number() over(partition by nama_mesin,shift order by detail_id) as no_urut_mesin, row_number() over(partition by kode,shift order by detail_id) as no_urut_kode');
