<?php
class M_formfrmfss317_14 extends CI_Model
{
        ...
        return $this->db1->query("with
                                    tbl_a as
                                        (select
                                            ...
                                            + sum(coalesce(nullif(rw_2_total,''), '0')::numeric)) * 0.9) dtl_b_air_gambut_sedimen_nilai,
                                            ...
                                            + sum(coalesce(nullif(cone_3_4_total,''), '0')::numeric))*0.9) dtl_b_air_gambut_cone_nilai,
                                            ...
                                            + sum(coalesce(nullif(cone_1_2_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(cone_3_4_total,''), '0')::numeric)) * 0.9) dtl_b_air_gambut_total_nilai,
                                    ...
                                    tbl_a2 as
                                        (select
                                            ...
                                            ((sum(coalesce(nullif(rw_1_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(rw_2_total,''), '0')::numeric)) * 0.9) dtl_b_air_gambut_sedimen_akumulatif,

                                            ((sum(coalesce(nullif(cone_1_2_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(cone_3_4_total,''), '0')::numeric)) * 0.9) dtl_b_air_gambut_cone_akumulatif,

                                            ((sum(coalesce(nullif(rw_1_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(rw_2_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(cone_1_2_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(cone_3_4_total,''), '0')::numeric)) * 0.9) dtl_b_air_gambut_total_akumulatif
