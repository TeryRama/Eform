<?php
class M_formfrmfss031_02 extends CI_Model
{
    ...
    {
        return $this->db1->query("select a.nama_mesin from $this->tabel4 a join $this->tabel5 b on a.headerid = b.headerid where b.dept = '$dept' order by a.nama_mesin asc")->result();
    }
