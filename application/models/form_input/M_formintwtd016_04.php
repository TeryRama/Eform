<?php
class M_formintwtd016_04 extends CI_Model
{

    var $tabel1 = 'tblfrmintwtd016hdr';
    var $tabel2 = 'tblfrmintwtd016dtl';
    var $tabel3 = 'tblfrmintwtd016dtlx';
    ...
    function get_list_item($create_date)
    {
        return $this->db1->query("select 
    ...
    /// check group
    function check($create_date, $docno, $rev, $periode)
    {
        $this->db1->from($this->tabel1);
    ...
    function check2($create_date, $docno, $rev, $periode, $headerid)
    {
        $this->db1->from($this->tabel1);
        $this->db1->where('create_date', $create_date);
        $this->db1->where('docno', $docno);
