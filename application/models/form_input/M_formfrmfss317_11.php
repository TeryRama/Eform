<?php
class M_formfrmfss317_11 extends CI_Model
{
    ...
    function get_frmfss315($create_date)
    {
        return $this->db1->query("with 																						
                                    tbl_a as
                                        (select
                                            ...
                                            + sum(coalesce(nullif(rw_2_total,''), '0')::numeric) dtl_b_air_gambut_sedimen_nilai,
                                            ...
                                            + sum(coalesce(nullif(cone_3_4_total,''), '0')::numeric) dtl_b_air_gambut_cone_nilai,
                                            ...
                                            + sum(coalesce(nullif(cone_1_2_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(cone_3_4_total,''), '0')::numeric) dtl_b_air_gambut_total_nilai,
                                    ...
                                    tbl_a2 as
                                        (select
                                            ...
                                            sum(coalesce(nullif(rw_1_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(rw_2_total,''), '0')::numeric) dtl_b_air_gambut_sedimen_akumulatif,

                                            sum(coalesce(nullif(cone_1_2_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(cone_3_4_total,''), '0')::numeric) dtl_b_air_gambut_cone_akumulatif,

                                            sum(coalesce(nullif(rw_1_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(rw_2_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(cone_1_2_total,''), '0')::numeric)
                                            + sum(coalesce(nullif(cone_3_4_total,''), '0')::numeric) dtl_b_air_gambut_total_akumulatif
                                    ...
                                    tbl_b2 as
                                        (select
                                            ...
                                            sum(
                                                case when 
                                                    (lower(replace(val_item1, ' ', '')) like '%anti scalan%')
                                                then
                                                    coalesce(nullif(baku_pakai,''), '0')::numeric
                                                else 
                                                    0 
                                    ...
                                    tbl_wtd as 
                                            (SELECT
                                                a.create_date,
                                                SUM ( COALESCE ( NULLIF ( operasi_akumulatif, '' ), '0' ) :: NUMERIC ) dtl_b_wtd_akumulatif 
                                            FROM
                                                tblfrmfrmfss317hdr
                                    ...
                                    left join
                                        tbl_wtd h
                                            on a.create_date=h.create_date
                                    where 
                                        a.status_detail_sf1 = '1'
                                        and a.status_detail_sf2 = '1'
                                        and a.status_detail_sf3 = '1'
    ...
    function get_frmfss316($create_date)
    {
        return $this->db1->query("with 
                                    ...
                                    select
                                        ...
                                        c.nama_jenis_air,
                                        c.nama_departemen,
                                        c.total_dept::numeric/b.grand_total*100 persen,
                                        c.total_dept total,
    ...
    function get_frmfss317_wtd($create_date){
        return $this->db1->query("SELECT
                                    ...
                                    WHERE
                                        A.create_date >= to_date( '$create_date', 'yyyy-mm-01' ) 
                                        AND A.create_date <= '$create_date' 
                                        AND b.operasi_jenis = 'WTD'")->result();
    }
