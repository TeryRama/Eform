<?php
class M_formfrmfss061_03 extends CI_Model
{

    var $tabel1 = 'tblfrmfrmfss061hdr';
    var $tabel2 = 'tblfrmfrmfss061dtl';
    var $tabel3 = 'tblfrmfrmfss061dtlx';
    ...
    function update_stdtlx($detail_id)
    {
        ...
        $this->db1->query("Update tblfrmfrmfss061dtlx set stdtl='0' where detail_id ='$detail_id'");
