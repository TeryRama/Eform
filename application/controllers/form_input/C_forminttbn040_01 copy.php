...
class C_forminttbn040_01 extends CI_Controller {
            ...
            if ($frmaksi == 'dtsave') {
                ...
                if ($cekheader->num_rows() > 0) {
                    ...
                    for ($i3 = 0; $i3 < $jmldtl_3; $i3++) {
                        ...
                        $user_status[$i3]           = null;
                        $user_personalid[$i3]       = null;
                        $user_nik[$i3]              = null;
                        $user_nama[$i3]             = null;

                        if ($user_id[$i3]          != '') {
                            $dt_user_by             = $this->model->get_user_by($user_id[$i3]);
                            
                            // echo "<pre>";
                            // print_r ($dt_user_by);
                            // echo "</pre>";exit();
                            
                            $user_status[$i3]       = $dt_user_by->personalstatus;  
                            $user_personalid[$i3]   = $dt_user_by->personalid;
                            $user_nik[$i3]          = $dt_user_by->nik;
                            $user_nama[$i3]         = $dt_user_by->nmlengkap;
                        }
                        ...
                        $data6 = array(
                            ...
                            'user_id'         => $user_id[$i3],
                            'user_status'     => $user_status[$i3],
                            'user_personalid' => $user_personalid[$i3],
                            'user_nik'        => $user_nik[$i3],
                            'user_nama'       => $user_nama[$i3],
                ...
                $data8  = array('dtdetail' => $dtdetail, 'dtdetailb' => $dtdetailb, 'dtdetailc' => $dtdetailc, 'dtdetaild' => $dtdetaild, 'dtdetaile' => $dtdetaile, 'dtdetailf' => $dtdetailf, 'data_user' => $data_user);
                // $data9  = array('dtdetailb' => $dtdetailb);
                // $data10 = array('dtdetailc' => $dtdetailc);
                // $data11 = array('dtdetaild' => $dtdetaild);
                // $data12 = array('dtdetaile' => $dtdetaile);
                // $data13 = array('dtdetailf' => $dtdetailf);
                // $data14 = array('dtdetailg' => $dtdetailg);
                // $data15 = array('data_user' => $data_user);
