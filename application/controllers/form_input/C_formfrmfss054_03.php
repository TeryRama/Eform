...
class C_formfrmfss054_03 extends CI_Controller
{
    ...
    function get_list_mesin_by()
    {
        if ($this->session->userdata('logged_in')) {
            ...
            $dthasil        = $this->model->get_list_mesin_by($dept);
                ...
                if ($cekheader->num_rows() > 0) {
                    ...
                    for ($i = 0; $i < $jml; $i++) {
                        ...
                        $data6 = array(
                            ...
                            'gugus'  => $dtl_a_gugus[$i],
                            'month1'     => date("Y-m-d", strtotime($dtl_a_month1[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month1[$i])),
                            'month2'     => date("Y-m-d", strtotime($dtl_a_month2[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month2[$i])),
                            'month3'     => date("Y-m-d", strtotime($dtl_a_month3[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month3[$i])),
                            'month4'     => date("Y-m-d", strtotime($dtl_a_month4[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month4[$i])),
                            'month5'     => date("Y-m-d", strtotime($dtl_a_month5[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month5[$i])),
                            'month6'     => date("Y-m-d", strtotime($dtl_a_month6[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month6[$i])),
                            'month7'     => date("Y-m-d", strtotime($dtl_a_month7[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month7[$i])),
                            'month8'     => date("Y-m-d", strtotime($dtl_a_month8[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month8[$i])),
                            'month9'     => date("Y-m-d", strtotime($dtl_a_month9[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month9[$i])),
                            'month10'    => date("Y-m-d", strtotime($dtl_a_month10[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month10[$i])),
                            'month11'    => date("Y-m-d", strtotime($dtl_a_month11[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month11[$i])),
                            'month12'    => date("Y-m-d", strtotime($dtl_a_month12[$i])) == '1970-01-01' ? NULL : date("Y-m-d", strtotime($dtl_a_month12[$i])),
                            'ket'        => $dtl_a_ket[$i],
                        );
