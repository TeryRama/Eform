...
class C_formintwtd014_01 extends CI_Controller
{
    ...
    function get_docno()
    {
        if ($this->session->userdata('logged_in')) {
            ...
            $docno        = 'POMUF/WTD/' . date("y", strtotime($create_date)) . '/' . $arr_bulan[(float)date("m", strtotime($create_date))] . '/' . str_pad($last_docno, 3, '0', STR_PAD_LEFT);
