...
class C_formfrmfss064_03 extends CI_Controller
{
    ...
    function form()
    {
        if ($this->session->userdata('logged_in')) {
            ...
            if ($frmaksi == 'dtsave') {
                $cekheader = $this->model->check($create_date, $docno, $rev, $dept, $deptabbr);
                ...
                if (isset($_POST['btnproses'])) {
                    $cekheader = $this->model->check2($create_date, $docno, $rev, $dept, $deptabbr, $headerid);
