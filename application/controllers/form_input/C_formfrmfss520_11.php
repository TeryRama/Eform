...
class C_formfrmfss520_11 extends CI_Controller
{
    ...
    function form()
    {
        if ($this->session->userdata('logged_in')) {
            ...
            $dtl_cek_shift_jam1 = preg_replace($pattern, '', $this->input->post('dtl_cek_shift_jam1'));
            $dtl_cek_shift_jam2 = preg_replace($pattern, '', $this->input->post('dtl_cek_shift_jam2'));
            $dtl_cek_shift_jam3 = preg_replace($pattern, '', $this->input->post('dtl_cek_shift_jam3'));
            $dtl_cek_shift_jam4 = preg_replace($pattern, '', $this->input->post('dtl_cek_shift_jam4'));
            $dtl_cek_shift_jam5 = preg_replace($pattern, '', $this->input->post('dtl_cek_shift_jam5'));
            $dtl_cek_shift_jam6 = preg_replace($pattern, '', $this->input->post('dtl_cek_shift_jam6'));
            $dtl_cek_shift_jam7 = preg_replace($pattern, '', $this->input->post('dtl_cek_shift_jam7'));
            $dtl_cek_shift_jam8 = preg_replace($pattern, '', $this->input->post('dtl_cek_shift_jam8'));

            // detail b
            $dtl_b_detail_id    = $this->input->post('dtl_b_detail_id');
            $dtl_b_shift        = $this->input->post('dtl_b_shift');
            $dtl_b_time_check   = preg_replace($pattern, '', $this->input->post('dtl_b_time_check'));
            $dtl_b_ph_air       = preg_replace($pattern, '', $this->input->post('dtl_b_ph_air'));
            $dtl_b_ph_caustic   = preg_replace($pattern, '', $this->input->post('dtl_b_ph_caustic'));
            $dtl_b_temp_caustic = preg_replace($pattern, '', $this->input->post('dtl_b_temp_caustic'));
            $dtl_b_ph_acid      = preg_replace($pattern, '', $this->input->post('dtl_b_ph_acid'));
            $dtl_b_temp_acid    = preg_replace($pattern, '', $this->input->post('dtl_b_temp_acid'));

            // detail c
            $dtl_c_detail_id      = $this->input->post('dtl_c_detail_id');
            $dtl_c_shift          = $this->input->post('dtl_c_shift');
            $dtl_c_time_check     = preg_replace($pattern, '', $this->input->post('dtl_c_time_check'));
            $dtl_c_ph             = preg_replace($pattern, '', $this->input->post('dtl_c_ph'));
            $dtl_c_residu_caustic = preg_replace($pattern, '', $this->input->post('dtl_c_residu_caustic'));
            $dtl_c_residu_acid    = preg_replace($pattern, '', $this->input->post('dtl_c_residu_acid'));
