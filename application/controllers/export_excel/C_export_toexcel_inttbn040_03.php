...
class C_export_toexcel_inttbn040_03 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        $dtheader = $this->M_forminttbn040_03->get_header_byid($this->header_id);
        ...
        if ($this->cekLevelUserNm == "Auditor") {
            $dtdetail   = $this->M_forminttbn040_03->get_detail_byidx($this->header_id);
            $dtdetailb = $this->M_forminttbn040_03->get_detail_byidbx($this->header_id);
            $dtdetailc = $this->M_forminttbn040_03->get_detail_byidcx($this->header_id);
            $dtdetaild = $this->M_forminttbn040_03->get_detail_byiddx($this->header_id);
            $dtdetaile = $this->M_forminttbn040_03->get_detail_byidex($this->header_id);
            $dtdetailf = $this->M_forminttbn040_03->get_detail_byidfx($this->header_id);
            $dtdetailg = $this->M_forminttbn040_03->get_detail_byidgx($this->header_id);
        } else {
            $dtdetail   = $this->M_forminttbn040_03->get_detail_byid($this->header_id);
            $dtdetailb = $this->M_forminttbn040_03->get_detail_byidb($this->header_id);
            $dtdetailc = $this->M_forminttbn040_03->get_detail_byidc($this->header_id);
            $dtdetaild = $this->M_forminttbn040_03->get_detail_byidd($this->header_id);
            $dtdetaile = $this->M_forminttbn040_03->get_detail_byide($this->header_id);
            $dtdetailf = $this->M_forminttbn040_03->get_detail_byidf($this->header_id);
            $dtdetailg = $this->M_forminttbn040_03->get_detail_byidg($this->header_id);
        }
        ...
        foreach($dtdetailc AS $dtdetail_c_row){
            ...
            $benda_asing[]          = $dtdetail_c_row->benda_asing;
            $kotoran[]              = $dtdetail_c_row->kotoran;
        ...
        for ($i1 = 0; $i1 < $jml_page; $i1++) {
            ...
            $objPHPExcel->mergeCells('A' .  ($table2_ke3 + 1) . ':B' .  ($table2_ke3 + 2))->setCellValue('A' .  ($table2_ke3 + 1), 'JAM');
            $objPHPExcel->mergeCells('C' .  ($table2_ke3 + 1) . ':J' .  ($table2_ke3 + 2))->setCellValue('C' .  ($table2_ke3 + 1), 'URAIAN KETIDAKSESUAIAN');
            $objPHPExcel->mergeCells('K' .  ($table2_ke3 + 1) . ':T' .  ($table2_ke3 + 2))->setCellValue('K' .  ($table2_ke3 + 1), 'TINDAKAN PERBAIKAN');
            $objPHPExcel->mergeCells('U' .  ($table2_ke3 + 1) . ':Y' .  ($table2_ke3 + 2))->setCellValue('U' .  ($table2_ke3 + 1), 'NAMA');
            $objPHPExcel->mergeCells('Z' .  ($table2_ke3 + 1) . ':AB' .  ($table2_ke3 + 2))->setCellValue('Z' .  ($table2_ke3 + 1), 'SHIFT');
            $objPHPExcel->mergeCells('AC' .  ($table2_ke3 + 1) . ':AN' .  ($table2_ke3 + 1))->setCellValue('AC' .  ($table2_ke3 + 1), 'KONDISI PENGECEKAN');
            $objPHPExcel->mergeCells('AC' .  ($table2_ke3 + 2) . ':AF' .  ($table2_ke3 + 2))->setCellValue('AC' .  ($table2_ke3 + 2), 'BENDA ASING');
            $objPHPExcel->mergeCells('AG' .  ($table2_ke3 + 2) . ':AJ' .  ($table2_ke3 + 2))->setCellValue('AG' .  ($table2_ke3 + 2), 'KOTORAN / NAJIS');
            $objPHPExcel->mergeCells('AK' .  ($table2_ke3 + 2) . ':AN' .  ($table2_ke3 + 2))->setCellValue('AK' .  ($table2_ke3 + 2), 'KETERANGAN');
            ...
            $objPHPExcel->setSharedStyle($DetailheaderStyle, 'A' . ($table2_ke3 + 1) . ':AN' . ($table2_ke3 + 2));

            $dtl_row3_ke3 = $table2_ke3 + 3;
            for ($arr = $start_detail; $arr <= $finish_detail; $arr++) {
                ...
                if (isset($shift[$arr])) { $dt_shift[$arr] = $shift[$arr]; } else { $dt_shift[$arr] = ""; }
                ...
                if (isset($benda_asing[$arr])) { $dt_benda_asing[$arr] = $benda_asing[$arr]; } else { $dt_benda_asing[$arr] = ""; }
                if($dt_benda_asing[$arr] == 'normal') {
                    $dt_benda_asing[$arr] = '✓';
                }elseif ($dt_benda_asing[$arr] == 'tidak normal') {
                    $dt_benda_asing[$arr] = '✘';
                }else{
                    $dt_benda_asing[$arr] = "";
                }
                if (isset($kotoran[$arr])) { $dt_kotoran[$arr] = $kotoran[$arr]; } else { $dt_kotoran[$arr] = ""; }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
                if($dt_kotoran[$arr] == 'normal') {
                    $dt_kotoran[$arr] = '✓';
                }elseif ($dt_kotoran[$arr] == 'tidak normal') {
                    $dt_kotoran[$arr] = '✘';
                }else{
                    $dt_kotoran[$arr] = "";
                }
                    ...
                    $objPHPExcel->mergeCells('Z' .  $dtl_row3_ke3 . ':AB' .  $dtl_row3_ke3)->setCellValue('Z' .  $dtl_row3_ke3, $dt_shift[$arr]);
                    $objPHPExcel->mergeCells('AC' .  $dtl_row3_ke3 . ':AF' .  $dtl_row3_ke3)->setCellValue('AC' .  $dtl_row3_ke3, $dt_benda_asing[$arr]);
                    $objPHPExcel->mergeCells('AG' .  $dtl_row3_ke3 . ':AJ' .  $dtl_row3_ke3)->setCellValue('AG' .  $dtl_row3_ke3, $dt_kotoran[$arr]);
                    $objPHPExcel->mergeCells('AK' .  $dtl_row3_ke3 . ':AN' .  $dtl_row3_ke3)->setCellValue('AK' .  $dtl_row3_ke3, $dt_keterangan[$arr]);
                    ...
                    // } else {
                    //     if ($dt_pj_perso nalid[$arr] != '' && file_exists($_SERVER['DOCUMENT_ROOT'] . $pj_imageurl . $dt_pj_personalid[$arr] . $pj_imageformat)) {
                    //         $objPHPExcel->getRowDimension($dtl_row3_ke3)->setRowHeight(50);
            ...
            $objPHPExcel->mergeCells('AH' . ($app_row_ke3) . ':AK' . ($app_row_ke3 + 1))->setCellValue('AH' . ($app_row_ke3), 'KETERANGAN :');
            $objPHPExcel->mergeCells('AH' . ($app_row_ke3 + 2) . ':AK' . ($app_row_ke3 + 2))->setCellValue('AH' . ($app_row_ke3 + 2), '✓ : NORMAL');
            $objPHPExcel->mergeCells('AH' . ($app_row_ke3 + 3) . ':AK' . ($app_row_ke3 + 3))->setCellValue('AH' . ($app_row_ke3 + 3), '✘ : TIDAK NORMAL');
