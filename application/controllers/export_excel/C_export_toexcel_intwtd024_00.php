...
class C_export_toexcel_intwtd024_00 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        if ($this->cekLevelUserNm == 'Auditor') {
            $date_calender = $this->M_formintwtd024_00->get_date_calender($bulan, $tahun);
            $dtdetail_lap = $this->M_formintwtd024_00->get_detail_lap_bydate($bulan, $tahun);
        } else {
            $date_calender = $this->M_formintwtd024_00->get_date_calender($bulan, $tahun);
            $dtdetail_lap = $this->M_formintwtd024_00->get_detail_lap_bydate($bulan, $tahun);
        }
        ...
        for ($i1 = 0; $i1 < $jml_page; $i1++) {
            ...
            for ($arr = 0; $arr < count($dtdetail_lap); $arr++) { 
                 ...
                 if($nama_jenis_air[$arr] == 'ACF'){
                    ...
                    $objPHPExcel->mergeCells('E' . ($detail) . ':J' . ($detail))->setCellValue('E' . ($detail), $nama_departemen[$arr]);
                ...
                if($nama_jenis_air[$arr] == 'ASF'){
                    ...
                    $objPHPExcel->mergeCells('E' . ($detail + 1) . ':J' . ($detail + 1))->setCellValue('E' . ($detail + 1), $nama_departemen[$arr]);
                ...
                if($nama_jenis_air[$arr] == 'AST'){
                    ...
                    $objPHPExcel->mergeCells('E' . ($detail + 2) . ':J' . ($detail + 2))->setCellValue('E' . ($detail + 2), $nama_departemen[$arr]);
                ...
                if($nama_jenis_air[$arr] == 'RO'){
                    ...
                    $objPHPExcel->mergeCells('E' . ($detail + 3) . ':J' . ($detail + 3))->setCellValue('E' . ($detail + 3), $nama_departemen[$arr]);
                ...
                if($nama_jenis_air[$arr] == 'UF'){
                    ...
                    $objPHPExcel->mergeCells('E' . ($detail + 4) . ':J' . ($detail + 4))->setCellValue('E' . ($detail + 4), $nama_departemen[$arr]);
