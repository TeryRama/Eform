...
class C_export_toexcel_frmfss317_14 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        $dtheader = $this->M_formfrmfss317_14->get_header_byid($this->header_id);
        ...
        if ($this->cekLevelUserNm == 'Auditor') {
            $dtdetail         = $this->M_formfrmfss317_14->get_detail_byidx($this->header_id);
            $dtdetail_b       = $this->M_formfrmfss317_14->get_detail_byid_bx($this->header_id);
            $dtdetail_c       = $this->M_formfrmfss317_14->get_detail_byid_cx($this->header_id);
            $dtdetail_c_uf    = $this->M_formfrmfss317_14->get_detail_byid_c_ufx($this->header_id);
            $dtdetail_d       = $this->M_formfrmfss317_14->get_detail_byid_dx($this->header_id);
            $dtdetail_e       = $this->M_formfrmfss317_14->get_detail_byid_ex($this->header_id);
            $dtdetail_f       = $this->M_formfrmfss317_14->get_detail_byid_fx($this->header_id);
            $dtdetail_g       = $this->M_formfrmfss317_14->get_detail_byid_gx($this->header_id);
            $dtdetail_h       = $this->M_formfrmfss317_14->get_detail_byid_hx($this->header_id);
            $dtdetail_i       = $this->M_formfrmfss317_14->get_detail_byid_ix($this->header_id);
            $dtdetail_j       = $this->M_formfrmfss317_14->get_detail_byid_jx($this->header_id);
            $dtdetail_k       = $this->M_formfrmfss317_14->get_detail_byid_kx($this->header_id);
            $dtdetail_l       = $this->M_formfrmfss317_14->get_detail_byid_lx($this->header_id);
            $dtdetail_m       = $this->M_formfrmfss317_14->get_detail_byid_mx($this->header_id);
            $dtdetail_n       = $this->M_formfrmfss317_14->get_detail_byid_nx($this->header_id);
            $dtdetail_o       = $this->M_formfrmfss317_14->get_detail_byid_ox($this->header_id);
            $dtdetail_p       = $this->M_formfrmfss317_14->get_detail_byid_px($this->header_id);
        } else {
            $dtdetail         = $this->M_formfrmfss317_14->get_detail_byid($this->header_id);
            $dtdetail_b       = $this->M_formfrmfss317_14->get_detail_byid_b($this->header_id);
            $dtdetail_c       = $this->M_formfrmfss317_14->get_detail_byid_c($this->header_id);
            $dtdetail_c_uf    = $this->M_formfrmfss317_14->get_detail_byid_c_uf($this->header_id);
            $dtdetail_d       = $this->M_formfrmfss317_14->get_detail_byid_d($this->header_id);
            $dtdetail_e       = $this->M_formfrmfss317_14->get_detail_byid_e($this->header_id);
            $dtdetail_f       = $this->M_formfrmfss317_14->get_detail_byid_f($this->header_id);
            $dtdetail_g       = $this->M_formfrmfss317_14->get_detail_byid_g($this->header_id);
            $dtdetail_h       = $this->M_formfrmfss317_14->get_detail_byid_h($this->header_id);
            $dtdetail_i       = $this->M_formfrmfss317_14->get_detail_byid_i($this->header_id);
            $dtdetail_j       = $this->M_formfrmfss317_14->get_detail_byid_j($this->header_id);
            $dtdetail_k       = $this->M_formfrmfss317_14->get_detail_byid_k($this->header_id);
            $dtdetail_l       = $this->M_formfrmfss317_14->get_detail_byid_l($this->header_id);
            $dtdetail_m       = $this->M_formfrmfss317_14->get_detail_byid_m($this->header_id);
            $dtdetail_n       = $this->M_formfrmfss317_14->get_detail_byid_n($this->header_id);
            $dtdetail_o       = $this->M_formfrmfss317_14->get_detail_byid_o($this->header_id);
            $dtdetail_p       = $this->M_formfrmfss317_14->get_detail_byid_p($this->header_id);
        }
