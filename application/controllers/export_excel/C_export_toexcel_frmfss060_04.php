...
class C_export_toexcel_frmfss060_04 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        $dtheader = $this->M_formfrmfss060_04->get_header_byid($this->header_id);
        ...
        if ($this->cekLevelUserNm == "Auditor") {
            $dtdetail   = $this->M_formfrmfss060_04->get_detail_byidx($this->header_id);
        } else {
            $dtdetail   = $this->M_formfrmfss060_04->get_detail_byid($this->header_id);
        }
