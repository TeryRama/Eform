...
class C_export_toexcel_frmfss188_01 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        $dtheader = $this->M_formfrmfss188_01->get_header_byid($this->header_id);
        ...
        if ($this->cekLevelUserNm == "Auditor") {
            $dtdetail   = $this->M_formfrmfss188_01->get_detail_byidx($this->header_id);
        } else {
            $dtdetail   = $this->M_formfrmfss188_01->get_detail_byid($this->header_id);
        }
        ...
        foreach ($dtdetail as $dtdetail_row) {
            ...
            $nomor[]                          = $no++;
            $point[]                          = $this->M_formfrmfss188_01->get_item_by($dtdetail_row->point)->item1;
            $kode[]                           = $this->M_formfrmfss188_01->get_item2_by($dtdetail_row->kode)->item2;
