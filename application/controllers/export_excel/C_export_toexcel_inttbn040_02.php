...
class C_export_toexcel_inttbn040_02 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        $dtheader = $this->M_forminttbn040_02->get_header_byid($this->header_id);
        ...
        if ($this->cekLevelUserNm == "Auditor") {
            $dtdetail   = $this->M_forminttbn040_02->get_detail_byidx($this->header_id);
            $dtdetailb = $this->M_forminttbn040_02->get_detail_byidbx($this->header_id);
            $dtdetailc = $this->M_forminttbn040_02->get_detail_byidcx($this->header_id);
            $dtdetaild = $this->M_forminttbn040_02->get_detail_byiddx($this->header_id);
            $dtdetaile = $this->M_forminttbn040_02->get_detail_byidex($this->header_id);
            $dtdetailf = $this->M_forminttbn040_02->get_detail_byidfx($this->header_id);
            $dtdetailg = $this->M_forminttbn040_02->get_detail_byidgx($this->header_id);
        } else {
            $dtdetail   = $this->M_forminttbn040_02->get_detail_byid($this->header_id);
            $dtdetailb = $this->M_forminttbn040_02->get_detail_byidb($this->header_id);
            $dtdetailc = $this->M_forminttbn040_02->get_detail_byidc($this->header_id);
            $dtdetaild = $this->M_forminttbn040_02->get_detail_byidd($this->header_id);
            $dtdetaile = $this->M_forminttbn040_02->get_detail_byide($this->header_id);
            $dtdetailf = $this->M_forminttbn040_02->get_detail_byidf($this->header_id);
            $dtdetailg = $this->M_forminttbn040_02->get_detail_byidg($this->header_id);
        }
        ...
        for ($i1 = 0; $i1 < $jml_page; $i1++) {
            ...
            $objPHPExcel->mergeCells('Z' .  ($table2_ke3 + 1) . ':AB' .  ($table2_ke3 + 1))->setCellValue('Z' .  ($table2_ke3 + 1), 'SHIFT');
