...
class C_export_toexcel_frmfss520_11 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        for ($i1 = 0; $i1 < $jml_page; $i1++) {
            ...
            if (($i1 + 1) != ($jml_page)) {
                ...
                $objPHPExcel->mergeCells('Q'  . ($start_table2 + 4) . ':T' . ($start_table2 + 4))->setCellValue('Q' .  ($start_table2 + 4), "pH (< 2)");
                ...
                $objPHPExcel->mergeCells('AN'  . ($start_table2 + 4) . ':AQ' . ($start_table2 + 4))->setCellValue('AN' .  ($start_table2 + 4), "pH (< 2)");
                ...
                $objPHPExcel->mergeCells('BK'  . ($start_table2 + 4) . ':BN' . ($start_table2 + 4))->setCellValue('BK' .  ($start_table2 + 4), "pH (< 2)");
