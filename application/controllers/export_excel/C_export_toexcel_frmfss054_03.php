...
class C_export_toexcel_frmfss054_03 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        $dtheader = $this->M_formfrmfss054_03->get_header_byid($this->header_id);
        ...
        $list_month = $this->M_formfrmfss054_03->get_month($tahun);
        if ($this->cekLevelUserNm == 'Auditor') {
            $dtdetail   = $this->M_formfrmfss054_03->get_detail_byidx($this->header_id);
        } else {
            $dtdetail   = $this->M_formfrmfss054_03->get_detail_byid($this->header_id);
        }
