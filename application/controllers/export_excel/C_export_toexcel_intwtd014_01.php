...
class C_export_toexcel_intwtd014_01 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
        ...
        for ($i1 = 0; $i1 < $jml_page; $i1++) {
            ...
            for ($a = 0; $a <= $bagidata[$i1]; $a++) {
                ...
                if ($dt_no_urut[$jumlahdata-1] == 1) {
                    $objPHPExcel->mergeCells('D' .  $dtl_row . ':F' .  ($dtl_row + $dt_no_urut_desc[$jumlahdata-1]-1))->setCellValue('D' .  $dtl_row, $dt_nama_mesin[$jumlahdata-1]);
                    $objPHPExcel->mergeCells('BP' . $dtl_row  . ':BV' . ($dtl_row + $dt_no_urut_desc[$jumlahdata-1]-1))->setCellValue('BP' . $dtl_row, "CIP dilakukan jika :
                                                                                                                                                        TMP mencapai 1 bar");
                } else {
