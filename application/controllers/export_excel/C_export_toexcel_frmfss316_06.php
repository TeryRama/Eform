...
class C_export_toexcel_frmfss316_06 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        $dtheader = $this->M_formfrmfss316_06->get_header_byid($this->header_id);
        ...
        if ($this->cekLevelUserNm == "Auditor") {
            $dtdetail   = $this->M_formfrmfss316_06->get_detail_lap_byidx($this->header_id);
        } else {
            $dtdetail   = $this->M_formfrmfss316_06->get_detail_lap_byid($this->header_id);
        }
