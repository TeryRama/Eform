...
class C_export_toexcel_frmfss317_11 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        $dtheader = $this->M_formfrmfss317_11->get_header_byid($this->header_id);
        ...
        if ($this->cekLevelUserNm == 'Auditor') {
            $dtdetail         = $this->M_formfrmfss317_11->get_detail_byidx($this->header_id);
            $dtdetail_b       = $this->M_formfrmfss317_11->get_detail_byid_bx($this->header_id);
            $dtdetail_c       = $this->M_formfrmfss317_11->get_detail_byid_cx($this->header_id);
            $dtdetail_c_uf    = $this->M_formfrmfss317_11->get_detail_byid_c_ufx($this->header_id);
            $dtdetail_d       = $this->M_formfrmfss317_11->get_detail_byid_dx($this->header_id);
            $dtdetail_e       = $this->M_formfrmfss317_11->get_detail_byid_ex($this->header_id);
            $dtdetail_f       = $this->M_formfrmfss317_11->get_detail_byid_fx($this->header_id);
            $dtdetail_g       = $this->M_formfrmfss317_11->get_detail_byid_gx($this->header_id);
            $dtdetail_h       = $this->M_formfrmfss317_11->get_detail_byid_hx($this->header_id);
            $dtdetail_i       = $this->M_formfrmfss317_11->get_detail_byid_ix($this->header_id);
            $dtdetail_j       = $this->M_formfrmfss317_11->get_detail_byid_jx($this->header_id);
            $dtdetail_k       = $this->M_formfrmfss317_11->get_detail_byid_kx($this->header_id);
            $dtdetail_l       = $this->M_formfrmfss317_11->get_detail_byid_lx($this->header_id);
            $dtdetail_m       = $this->M_formfrmfss317_11->get_detail_byid_mx($this->header_id);
            $dtdetail_n       = $this->M_formfrmfss317_11->get_detail_byid_nx($this->header_id);
            $dtdetail_o       = $this->M_formfrmfss317_11->get_detail_byid_ox($this->header_id);
            $dtdetail_p       = $this->M_formfrmfss317_11->get_detail_byid_px($this->header_id);
        } else {
            $dtdetail         = $this->M_formfrmfss317_11->get_detail_byid($this->header_id);
            $dtdetail_b       = $this->M_formfrmfss317_11->get_detail_byid_b($this->header_id);
            $dtdetail_c       = $this->M_formfrmfss317_11->get_detail_byid_c($this->header_id);
            $dtdetail_c_uf    = $this->M_formfrmfss317_11->get_detail_byid_c_uf($this->header_id);
            $dtdetail_d       = $this->M_formfrmfss317_11->get_detail_byid_d($this->header_id);
            $dtdetail_e       = $this->M_formfrmfss317_11->get_detail_byid_e($this->header_id);
            $dtdetail_f       = $this->M_formfrmfss317_11->get_detail_byid_f($this->header_id);
            $dtdetail_g       = $this->M_formfrmfss317_11->get_detail_byid_g($this->header_id);
            $dtdetail_h       = $this->M_formfrmfss317_11->get_detail_byid_h($this->header_id);
            $dtdetail_i       = $this->M_formfrmfss317_11->get_detail_byid_i($this->header_id);
            $dtdetail_j       = $this->M_formfrmfss317_11->get_detail_byid_j($this->header_id);
            $dtdetail_k       = $this->M_formfrmfss317_11->get_detail_byid_k($this->header_id);
            $dtdetail_l       = $this->M_formfrmfss317_11->get_detail_byid_l($this->header_id);
            $dtdetail_m       = $this->M_formfrmfss317_11->get_detail_byid_m($this->header_id);
            $dtdetail_n       = $this->M_formfrmfss317_11->get_detail_byid_n($this->header_id);
            $dtdetail_o       = $this->M_formfrmfss317_11->get_detail_byid_o($this->header_id);
            $dtdetail_p       = $this->M_formfrmfss317_11->get_detail_byid_p($this->header_id);
        }
        ...
        for ($i1 = 0; $i1 < $jml_page; $i1++) {
            ...
            for ($a = $start_detail; $a <= $finish_detail; $a++) {
                ...
                if($dt_nama_jenis_air[$a] == 'ACF'){
                    ...
                    $objPHPExcel->mergeCells('Y' . ($dtl_row_a) . ':AD' . ($dtl_row_a))->setCellValue('Y' . ($dtl_row_a), $dt_persen[$a]);
                    ...
                    $objPHPExcel->mergeCells('Y' . ($dtl_row_a + ($dt_no_urut_desc[$a]+1)) . ':AD' . ($dtl_row_a + ($dt_no_urut_desc[$a]+1)))->setCellValue('Y' . ($dtl_row_a + ($dt_no_urut_desc[$a]+1)), $dt_total_acf_persen);
                ...
                if ($dt_nama_jenis_air[$a] == 'ASF') {
                    ...
                    $objPHPExcel->mergeCells('Y' . ($dtl_row_a + 1) . ':AD' . ($dtl_row_a + 1))->setCellValue('Y' . ($dtl_row_a + 1), $dt_persen[$a]);
                    ...
                    $objPHPExcel->mergeCells('Y' . ($dtl_row_a + ($dt_no_urut_desc[$a] + 2)) . ':AD' . ($dtl_row_a + ($dt_no_urut_desc[$a] + 2)))->setCellValue('Y' . ($dtl_row_a + ($dt_no_urut_desc[$a] + 2)), $dt_total_asf_persen);
                ...
                if ($dt_nama_jenis_air[$a] == 'AST') {
                    ...
                    $objPHPExcel->mergeCells('Y' . ($dtl_row_a + 2) . ':AD' . ($dtl_row_a + 2))->setCellValue('Y' . ($dtl_row_a + 2), $dt_persen[$a]);
                    ...
                    $objPHPExcel->mergeCells('Y' . ($dtl_row_a + ($dt_no_urut_desc[$a] + 3)) . ':AD' . ($dtl_row_a + ($dt_no_urut_desc[$a] + 3)))->setCellValue('Y' . ($dtl_row_a + ($dt_no_urut_desc[$a] + 3)), $dt_total_ast_persen);
                ...
                if ($dt_nama_jenis_air[$a] == 'RO') {
                    ...
                    $objPHPExcel->mergeCells('Y' . ($dtl_row_a + 3) . ':AD' . ($dtl_row_a + 3))->setCellValue('Y' . ($dtl_row_a + 3), $dt_persen[$a]);
                    ...
                    $objPHPExcel->mergeCells('Y' . ($dtl_row_a + ($dt_no_urut_desc[$a] + 4)) . ':AD' . ($dtl_row_a + ($dt_no_urut_desc[$a] + 4)))->setCellValue('Y' . ($dtl_row_a + ($dt_no_urut_desc[$a] + 4)), $dt_total_ro_persen);
            ...
            $objPHPExcel->mergeCells('Y' . ($total_row) . ':AD' . ($total_row))->setCellValue('Y' . ($total_row), $dtl_a_grand_total_persen);
            ...
            $objPHPExcel->mergeCells('AK' . ($dtl_row_e) . ':BD' . ($dtl_row_e))->setCellValue('AK' . ($dtl_row_e), '');
            $objPHPExcel->setSharedStyle($DetailheaderStyle, 'AK' . ($dtl_row_e) . ':BD' . ($dtl_row_e));
            $objPHPExcel->getStyle('AK' . ($dtl_row_e) . ':BD' . ($dtl_row_e))->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID, 'color' => array('rgb' => '99ff99'))));
            $objPHPExcel->mergeCells('AK' . ($dtl_row_e + 1) . ':BD' . ($dtl_row_e + 1))->setCellValue('AK' . ($dtl_row_e + 1), 'PROSES AIR RECYCLE');
            ...
            for ($a = $start_detail; $a <= $finish_detail; $a++) {
                ...
                $objPHPExcel->mergeCells('AR' . $dtl_row_f . ':BA' . $dtl_row_f)->setCellValue('AR' . $dtl_row_f, $dt_operasi_nilai_f[$a]);
            ...
            $objPHPExcel->mergeCells('AR' . ($dtl_row_f) . ':BA' . ($dtl_row_f))->setCellValue('AR' . ($dtl_row_f),  $total_dtl_f_operasi_nilai );
            ...
            $objPHPExcel->mergeCells('AK' . ($dtl_row_f + 2) . ':AQ' . ($dtl_row_f + 2))->setCellValue('AK' . ($dtl_row_f + 2), 'Stok Air Akhir');
            ...
            $objPHPExcel->mergeCells('BB' . ($dtl_row_g) . ':BD' . ($dtl_row_g))->setCellValue('BB' . ($dtl_row_g),  $dtl_g_total_bawah );
            ...
            $objPHPExcel->mergeCells('AK' . ($dtl_row_h + 1) . ':AU' . ($dtl_row_h + 1))->setCellValue('AK' . ($dtl_row_h + 1), "Drain Sedimen (M3)");
            $objPHPExcel->mergeCells('AK' . ($dtl_row_h + 2) . ':AU' . ($dtl_row_h + 2))->setCellValue('AK' . ($dtl_row_h + 2), "Backwash Tanki (M3)");
            $objPHPExcel->mergeCells('AK' . ($dtl_row_h + 3) . ':AU' . ($dtl_row_h + 3))->setCellValue('AK' . ($dtl_row_h + 3), "Cleaning Bak (M3)");
            $objPHPExcel->mergeCells('AK' . ($dtl_row_h + 4) . ':AU' . ($dtl_row_h + 4))->setCellValue('AK' . ($dtl_row_h + 4), "Operasional/Cleaning WTD (M3)");
            ...
            for ($a = $start_detail; $a <= $finish_detail; $a++) {
                ...
                $objPHPExcel->setSharedStyle($bodyStyleLeft, 'AK' . ($dtl_row_h ) . ':AK' . ($dtl_row_h + 3));
                $dtl_row_h++;
            }
