...
class C_export_toexcel_frmfss315_18 extends CI_Controller
{
    private $xls;
    private $spreadsheet;
    ...
    function exportxls()
    {
        ...
        for ($i1 = 0; $i1 < $jml_page; $i1++) {
            ...
            $objPHPExcel->mergeCells('AW' . ($start_row + 3) . ':BL' . ($start_row + 3))->setCellValue('AW' . ($start_row + 3), "Proses Cone");
            ...
            $objPHPExcel->mergeCells('A' . ($app_row + 8) . ':C' . ($app_row + 8))->setCellValue('A' . ($app_row + 8), 'Jabatan');
