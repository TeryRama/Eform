...
class C_pembuatan_form extends CI_Controller {
	...
	function __construct() {
		...
		$this->load->model(array('M_menu','tambahan/lain_lain/M_pembuatan_form'));
	...
	function index() {
        if($this->session->userdata('logged_in')) {
            ...
            $list_permintaan      = $this->M_pembuatan_form->get_list_permintaan();
            $data_list_permintaan = array('list_permintaan' => $list_permintaan);

            $data['date_from']       = '';
            $data['date_to']         = '';

            $this->load->view('tambahan/lain_lain/V_pembuatan_form', array_merge($data, $data2, $data_list_permintaan));
    ...
    function get_pembuatan_form() {
        if($this->session->userdata('logged_in')) {
            ...
            $list_bagian      = $this->M_pembuatan_form->get_list_bagian();
            ...
            if(isset($showall)){
              $pembuatan_form      = $this->M_pembuatan_form->get_pembuatan_form_all();
            }else{
              $pembuatan_form      = $this->M_pembuatan_form->get_pembuatan_form($bagian,$posisi,$level,$nik,$nama,$form_bagian,$form_kategori,$form_subkategori,$form_nama, $form_versi);
            }

            $data_pembuatan_form = array('pembuatan_form' => $pembuatan_form);

            if($pembuatan_form==false){$data['message'] ='Maaf Data Tidak Ditemukan..!!';}else{$data['message'] ='';}
            

            $this->load->view('tambahan/lain_lain/V_pembuatan_form', array_merge($data, $data2, $data_pembuatan_form, $data_list_bagian));
    ...
    function get_form_kategori(){
        if($this->session->userdata('logged_in')) {
            ...
            $result_kategori = $this->M_pembuatan_form->get_kategori($bagian);
    ...
    function get_form_subkategori(){
        if($this->session->userdata('logged_in')) {
            ...
            $result_subkategori = $this->M_pembuatan_form->get_subkategori($bagian, $form_kategori);
    ...
    function get_form_kode(){
        if($this->session->userdata('logged_in')) {
            ...
            $result_formkode = $this->M_pembuatan_form->get_formkode($bagian, $form_kategori, $form_subkategori);
    ...
    function get_form_versi(){
        if($this->session->userdata('logged_in')) {
            ...
            $result_formversi = $this->M_pembuatan_form->get_formversi($form_kode);
    ...
    function get_posisi(){
        if($this->session->userdata('logged_in')) {
            ...
            $result_posisi = $this->M_pembuatan_form->get_posisi($deptid);
            $result_level = $this->M_pembuatan_form->get_level($deptid);
