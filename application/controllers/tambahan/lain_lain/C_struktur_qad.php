...
class C_struktur_qad extends CI_Controller {
	...
	function __construct() {
		...
		$this->load->model(array('M_menu','tambahan/lain_lain/M_struktur_qad'));
	}
	...
	function index() {
		if($this->session->userdata('logged_in')) {
            ...
            $struktur_qad = $this->M_struktur_qad->get_struktur_qad();
            $data3 = array('struktur_qad' => $struktur_qad);

			$this->load->view('tambahan/lain_lain/V_struktur_qad', array_merge($data, $data2, $data3));
