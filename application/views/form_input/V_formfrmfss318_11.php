            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss318_11/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss520" name="formfrmfss520" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                                                        ...
                                                                        ?>
                                                                                    <tr>
                                                                                        ...
                                                                                        <?php if ($dtdetail_row->no_urut_mesin == 1) { // gabungin jadi satu kolom dan tulisan miring per nama mesin
                                                                                            if($dtdetail_row->nama_mesin == 'Flowrate air'){ ?>
                                                                                                <td align="center" rowspan="<?= ($dtdetail_row->jml_per_mesin * $dtdetail_row->jml_per_kode) ?>"><b><?= $dtdetail_row->nama_mesin ?></b></td>
                                                                                        <?php }else{ ?>
                                                                                                <td align="center" rowspan="<?= (($dtdetail_row->jml_per_mesin+12) * $dtdetail_row->jml_per_kode) ?>"><b><?= $dtdetail_row->nama_mesin ?></b></td>
                                                                                            <?php }
                                                                                        } ?>
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                ...
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss318_11/get_docno/frmfss318/11",
                    data: {
                        create_date
                    },
        ...
        function get_item(tbl, tbody, tipe_dtl) {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss318_11/get_list_item/frmfss318/11",
                    dataType: "json",
                    data: {
                        tipe_dtl,
                        create_date
                                ...
                                if (result.data[key].children) {
                                    $.each(result.data[key].children, function(key2, children_row) {
                                        if (result.data[key].children[key2].children2) {
                                            console.log(result.data[key].children.length)
                                            console.log(result.data[key].children[key2].children2.length)
                                            let vitem1 = '';
                                            if (key2 == 0) {
                                                if(list_item_row.item1 == 'Flowrate air'){
                                                    ...
                                                    vitem1 = `<td align="center" rowspan="`+ (result.data[key].children.length + 12) * result.data[key].children[key2].children2.length+`"><b>` + list_item_row.item1 + `</b></td>`;
                                                }
                                            }
                                            $.each(result.data[key].children[key2].children2, function(key3, children2_row) {
                                                ...
                                                list_dtl += `<tr> 
                                                                <td align="center">` + eval(no3) + `
                                                                    ...
                                                                    <input type="hidden" name="dtl_jml_per_mesin[]" id="dtl_jml_per_mesin" class="form-control w-auto dtl_jml_per_mesin" style="text-align: center;" value="` + result.data[key].children.length + `">
