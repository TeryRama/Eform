            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss054_04/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss054" name="formfrmfss054" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                        ...
                                        <div class="table-responsive" id="scrolling_table_1" style="max-height: 600px;">
                                            <table class="table table-striped table-bordered">
                                                <thead class="fixed freeze_vertical">
                                                    <tr>
                                                        <th class="fixed freeze_horizontal table-primary align-middle text-center" rowspan="2"></th>
                                                        <th class="fixed freeze_horizontal table-primary align-middle text-center" rowspan="2">Nama Mesin</th>
                                                        <th class="fixed freeze_horizontal table-primary align-middle text-center" rowspan="2">Kode Mesin</th>
                                                    ...
                                                    <?php if (isset($dtdetail)) {
                                                        ...
                                                        foreach ($dtdetail as $dtdetail_row) { ?>
                                                            <tr>
                                                                ...
                                                                <td class="fixed freeze_horizontal" style="background-color:white;" align="center"><input type="checkbox" name="dtl_a_chk[]" id="dtl_a_chk" class="dtl_a_chk" value="<?= $dtdetail_row->detail_id ?>"></td>
                                                                <td class="fixed freeze_horizontal" style="background-color:white;" align="center"><input type="text" name="dtl_a_nama_mesin[]" id="dtl_a_nama_mesin" class="dtl_a_nama_mesin form-control w-auto" value="<?= $dtdetail_row->nama_mesin ?>" readonly /></td>
                                                                <td class="fixed freeze_horizontal" style="background-color:white;" align="center"><input type="text" name="dtl_a_kode_mesin[]" id="dtl_a_kode_mesin" class="dtl_a_kode_mesin form-control w-auto" value="<?= $dtdetail_row->kode_mesin ?>" readonly /></td>
...
<script>
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss054_04/get_docno/frmfss054/04",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        $('.item').change(function() {
            ...
            get_list_mesin_by(deptabbr, item)
        })
        $(document).on('click', '#add_sch', function() {
            ...
            if (dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss054_04/get_add_sch/frmfss054/04",
                    data: {
                        headerid,
                        tahun,
                        dept,
                            ...
                            if (data.data) {
                                ...
                                $.each(data.data, function(key, list_dtl_row) {
                                    ...
                                    list_td += `<tr>
                                                        ...
                                                        <td style="background-color:white;" align="center" rowspan="1"><input type="hidden" name="mdl1_frequency[]" id="mdl1_frequency" class="form-control w-auto mdl1_frequency" style="text-align: center;" value="${list_dtl_row.frekuensi}">${list_dtl_row.frekuensi}</td>
                                                        <td align="center">
        ...
        $('#btnmodal_save').click(function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>index.php/form_input/C_formfrmfss054_04/save_modal_schedule/frmfss054/04",
                        type: 'POST',
                        dataType: 'json',
                        ...
                        success: function(data) {
                            ...
                            if (data.vstatus == 'success') {
                                Swal.fire(
                                    ...
                                    window.location.href = baseurl + 'index.php/form_input/C_formfrmfss054_04/form/frmfss054/04/dtopen/' + data.headerid;
                                });
                            }
                        },
                        error: function() {
    ...
    function get_gugus_by(dept) {
        if (dept != '') {
            $.ajax({
                type: "post",
                url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss054_04/get_gugus_by/frmfss054/04",
                data: {
                    dept
                },
                async: false,
    ...
    // var deptabbr = $('#deptabbr').val();
    function get_list_mesin_by(dept, item) {
        if (item == 'mesin') {
            $.ajax({
                type: "post",
                url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss054_04/get_list_mesin_by/frmfss054/04",
                data: {
                    dept,
                    item
                },
                ...
                success: function(data) {
                    if (data.status == 0) {
                        ...
                        $.each(data.data, function(key, dtl_val) {
                            list_dtl += `<tr>
                                    <td class="fixed freeze_horizontal scrolling_table_1" style="background-color:white;" align="center"><input type="checkbox" name="dtl_a_chk[]" id="dtl_a_chk" class="dtl_a_chk" value=""></td>
                                    <td class="fixed freeze_horizontal scrolling_table_1" style="background-color:white;" align="center"><input type="text" name="dtl_a_nama_mesin[]" id="dtl_a_nama_mesin" class="dtl_a_nama_mesin form-control w-auto" readonly value="${dtl_val.nama_mesin}"/></td>
                                    <td class="fixed freeze_horizontal scrolling_table_1" style="background-color:white;" align="center"><input type="text" name="dtl_a_kode_mesin[]" id="dtl_a_kode_mesin" class="dtl_a_kode_mesin form-control w-auto" readonly value="${dtl_val.kode_mesin}"/></td>
                                    <td class="fixed freeze_horizontal scrolling_table_1" style="background-color:white;" align="center"><input type="text" name="dtl_a_frekuensi[]" id="dtl_a_frekuensi" class="dtl_a_frekuensi form-control w-auto" readonly value="6 Bulan"></td>
                            ...
                            $.each(JSON.parse('<?= json_encode($list_month) ?>'), function(dtl_month_key, dtl_month_val) {
                                if (dtl_val.tanggal_perawatan != null && dtl_val.bulan == dtl_month_val.month) {
                                    dtl_tanggal = dtl_val.tanggal_perawatan;
                                } else {
                                    dtl_tanggal = '';
                                }
                                list_dtl += `<td align="centar"><input type="text" name="dtl_a_month${dtl_month_val.month}[]" id="dtl_a_month${dtl_month_val.month}" size="12" class="form-control w-auto datepicker_row maskdate dtl_a_month${dtl_month_val.month}" value="${dtl_tanggal}"></td>`;
                            });
                            list_dtl += `<td align="center"><input type="text" name="dtl_a_ket[]" id="dtl_a_ket" class="dtl_a_ket form-control w-auto" size="28" value=""></td>
                                </tr>`;
                        });
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss054_04/get_list_panel_by/frmfss054/04",
                data: {
                    dept,
                    item
                },
                    ...
                    if (data.status == 0) {
                        ...
                        $.each(data.data, function(key, dtl_val) {
                            list_dtl += `<tr>
                                    ...
                                    <td class="fixed freeze_horizontal scrolling_table_1" style="background-color:white;" align="center"><input type="text" name="dtl_a_nama_mesin[]" id="dtl_a_nama_mesin" class="dtl_a_nama_mesin form-control w-auto" readonly value="${dtl_val.nama_mesin}"/></td>
                                    <td class="fixed freeze_horizontal scrolling_table_1" style="background-color:white;" align="center"><input type="text" name="dtl_a_kode_mesin[]" id="dtl_a_kode_mesin" class="dtl_a_kode_mesin form-control w-auto" readonly value="${dtl_val.kode_mesin}"/></td>
                                    <td class="fixed freeze_horizontal scrolling_table_1" style="background-color:white;" align="center"><input type="text" name="dtl_a_frekuensi[]" id="dtl_a_frekuensi" class="dtl_a_frekuensi form-control w-auto" readonly value="1 Bulan"></td>
                                    <td align="center"><input type="text" name="dtl_a_gugus[]" id="dtl_a_gugus" class="dtl_a_gugus form-control w-auto" readonly value="${dtl_val.gugus != null ? dtl_val.gugus : '' }"></td>`;
                            $.each(JSON.parse('<?= json_encode($list_month) ?>'), function(dtl_month_key, dtl_month_val) {
                                if (dtl_val.tanggal_perawatan != null && dtl_val.bulan == dtl_month_val.month) {
                                    dtl_tanggal = dtl_val.tanggal_perawatan;
                                } else {
