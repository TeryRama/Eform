            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss812_01/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss061" name="formfrmfss061" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead id="thead" style="position:sticky;top: 0; z-index: 1;">
                                                    <tr>
                                                        ...
                                                        <th class="table-primary align-middle text-center" rowspan="2">Akumulatif Jam Operasi</th>
                                                    ...
                                                    if (isset($dtdetail)) {
                                                        ...
                                                        foreach ($dtdetail as $dtdetail_row) { 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="fixed freeze_horizontal" style="background-color:white;z-index:0;" align="left"><?= $dtdetail_row->nama_mesin ?></td>
                                                                <td class="fixed freeze_horizontal" style="background-color:white;z-index:0;" align="center"><?= $dtdetail_row->kode_mesin ?></td>
                                                                <td class="fixed freeze_horizontal" style="background-color:white;z-index:0;" align="center"><?= $dtdetail_row->frekuensi ?></td>
                                                                ...
                                                                <td align="center"><input type="hidden" name="dtl_a_akumulasi_awal[]" id="dtl_a_akumulasi_awal" class="dtl_a_akumulasi_awal form-control w-auto" size="5" value="<?= $dtdetail_row->akumulasi_operasi_awal ?>">
                                                                                    <input type="text" name="dtl_a_akumulasi[]" id="dtl_a_akumulasi" class="dtl_a_akumulasi form-control w-auto" size="5" value="<?= $dtdetail_row->akumulasi_operasi ?>"></td>
                                                                <td>
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss812_01/get_docno/frmfss812/01",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_jenis_mesin_by(dept, item) {
            ...
            if (typeof(input_headerid) == "undefined" && dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss812_01/get_jenis_mesin_by/frmfss812/01",
                    data: {
                        dept,
                        create_date,
                        item
        ...
        function get_gugus_by(id_jns_mesin) {
            ...
            if (typeof(input_headerid) == "undefined" && dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss812_01/get_gugus_by/frmfss812/01",
                    data: {
                        dept,
                        create_date,
                        id_jns_mesin
        ...
        function get_itemmesin(id_gugus) {
            ...
            if (typeof(input_headerid) == "undefined" && dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss812_01/get_itemmesin/frmfss812/01",
                    data: {
                        dept,
                        create_date,
                        id_jns_mesin,
                        ...
                        if(result.status==0){
                            ...
                            if(result.data.length){
                                ...
                                $.each(result.data, function(dtl_mesin_key, dtl_val_mesin) {
                                    ...
                                    console.log(val_operasi_akumulasi)
                                    list_mesin += `<tr>
                                    ...
                                    list_mesin += `<td align="center"><input type="text" name="dtl_a_jam_operasi[]" id="dtl_a_jam_operasi" class="dtl_a_jam_operasi form-control w-auto" size="5" value=""></td>
                                                    <td align="center"><input type="hidden" name="dtl_a_akumulasi_awal[]" id="dtl_a_akumulasi_awal" class="dtl_a_akumulasi_awal form-control w-auto" size="5" value="${val_operasi_akumulasi}">
                                                                        <input type="text" name="dtl_a_akumulasi[]" id="dtl_a_akumulasi" class="dtl_a_akumulasi form-control w-auto" size="5" value="${val_operasi_akumulasi}"></td>
                                                    <td align="center">
