                                                ...
                                                <?php if (!isset($dtdetailc)) {
                                                    if (isset($message)) {
                                                        for ($i = 0; $i < $jmldtl_3; $i++) { ?>
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control w-auto shift" name="shift[]" id="shift" style="text-align: center;" value="<?php echo set_value('shift[' . $i . ']'); ?>"></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control w-auto shift" name="shift[]" id="shift" style="text-align: center;" value=""></td>
                                                            <!-- <td align="center"><select name="dtlc_pj_id[]" id="dtlc_pj_id" class="form-control w-auto dtlc_pj_id">
                                                                                <option value="">- pilih -</option>
                                                                                <?php foreach ($list_pj as $list_pj_row) { ?>
                                                                                    <option value="<?= $list_pj_row->detail_id  ?>">
                                                            ...
                                                            <td></td> -->
                                                            <td><input type="text" class="form-control w-auto keterangan" name="keterangan[]" id="keterangan" style="text-align: center;" value=""></td>
                                                        </tr>
                                                    <?php
                                                    }
                                                } else {
                                                    ...
                                                    foreach ($dtdetailc as $row3) { 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control w-auto shift" name="shift[]" id="shift" style="text-align: center;" value="<?php echo $row3->shift; ?>"></td>
                                                            <!-- <td align="center"><select name="dtlc_pj_id[]" id="dtlc_pj_id" class="form-control w-auto dtlc_pj_id">
                                                                                <option value="">- pilih -</option>
                                                                                <?php foreach ($list_pj as $list_pj_row) { ?>
                                                            ...
                                                            <td><input type="text" class="form-control w-auto keterangan" name="keterangan[]" id="keterangan" style="text-align: center;" value="<?php echo $row3->keterangan; ?>"></td>
                                                        </tr>
                                                <?php
                                                    }
                                                } ?>
...
<script>
    ...
    function get_docno() {
        ...
        if (typeof(input_headerid) == "undefined" && create_date != '') {
            $.ajax({
                type: "post",
                url: "<?= base_url(); ?>index.php/form_input/C_forminttbn040_02/get_docno/inttbn040/02",
                data: {
                    create_date
                },
                async: false,
        ...
        function get_item(){
            ...
            if(typeof(input_headerid) == "undefined" && create_date != ''){
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_forminttbn040_02/get_item/inttbn040/02",
                    data: {
                        create_date
                    },
                    dataType: "json",
