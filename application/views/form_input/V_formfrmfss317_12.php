            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss317_12/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss317" name="formfrmfss317" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                ...
                                <div class="col-12">
                                    <?php if (!isset($dtheader)) {
                                        ...
                                        if ($akses_update == '1') { ?>
                                            ...
                                            <!-- <button type="button" class="btn bg-gradient-warning btnrefresh" onclick="return confirm('Refresh Data ?')">
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss317_12/get_docno/frmfss317/12",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_forminput() {
            ...
            if (create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss317_12/get_forminput/frmfss317/12",
                    data: {
                        create_date
                    },
                    dataType: "json",
                            ...
                            if (result.data.result_frmfss315.length && result.data.result_frmfss316.length && result.data.result_frmfss317.length) {
                                if (result.data.result_frmfss317[0].dtl_b_wtd_akumulatif != null) {
                                    list_dtl_b += `<tr>
                                                        ...
                                                        <td align="center">
                                                            <input type="text" name="dtl_b_operasi_akumulatif[]" id="dtl_b_operasi_akumulatif_wtd" class="dtl_b_operasi_akumulatif_wtd form-control w-auto" style="text-align: center;" value="` + parseFloat(result.data.result_frmfss317[0].dtl_b_wtd_akumulatif).toFixed(1) + `" required >
                                                            <input type="hidden" name="dtl_b_operasi_akumulatif_awal[]" id="dtl_b_operasi_akumulatif_wtd_awal" class="dtl_b_operasi_akumulatif_wtd_awal form-control w-auto" style="text-align: center;" value="` + parseFloat(result.data.result_frmfss317[0].dtl_b_wtd_akumulatif).toFixed(1) + `" required >
                                                        </td>
                                    ...
                                    list_dtl_b += `<tr>
                                                            ...
                                                            <td align="center">
                                                                <input type="text" name="dtl_b_operasi_akumulatif[]" id="dtl_b_operasi_akumulatif_wtd" class="dtl_b_operasi_akumulatif_wtd form-control w-auto" style="text-align: center;" value="0" required >
                                                                <input type="hidden" name="dtl_b_operasi_akumulatif_awal[]" id="dtl_b_operasi_akumulatif_wtd_awal" class="dtl_b_operasi_akumulatif_wtd_awal form-control w-auto" style="text-align: center;" value="0" required >
                                                            </td>
                                                            <td align="center">M3</td>
                                                        </tr>`;
                                }
