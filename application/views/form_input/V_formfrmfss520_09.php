            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss520_09/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss520" name="formfrmfss520" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                ...
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss520_09/get_docno/frmfss520/09",
                    data: {
                        create_date
                    },
        ...
        function get_item(tbl, tbody, tipe_dtl) {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss520_09/get_list_item/frmfss520/09",
                    dataType: "json",
                    data: {
                        tipe_dtl,
                        create_date
