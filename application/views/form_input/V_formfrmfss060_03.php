                                                    ...
                                                    <?php if (isset($dtdetail)) {
														...
														?>
                                                            <tr>
                                                                ...
                                                                <td align="center"><input type="text" name="dtl_a_keterangan[]" id="dtl_a_keterangan" class="dtl_a_keterangan form-control w-auto" size="15" value="<?= $dtdetail_row->keterangan; ?>"></td>
                                                            </tr>
                                                        <?php }
                                                    } ?>
                                                </tbody>
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss060_03/get_docno/frmfss060/03",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_frmfss812() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != ''&& periode != ''&& dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss060_03/get_frmfss812/frmfss060/03",
                    data: {
                        create_date,
                        periode,
                        dept
                        ...
                        if(result.result_frmfss812.length){
                            ...
                            $.each(result.result_frmfss812, function(dtl_a_key, dtl_a_val) {
                                list_dtl_a += `<tr>
                                                    ...
                                                    <td align="center"><input type="text" name="dtl_a_keterangan[]" id="dtl_a_keterangan" class="dtl_a_keterangan form-control w-auto" size="15" value=""></td>
                                                </tr>`;
                            });
                        }
