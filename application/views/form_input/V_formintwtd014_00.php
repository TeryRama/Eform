            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formintwtd014_00/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formintwtd014" name="formintwtd014" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                ...
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formintwtd014_00/get_docno/intwtd014/00",
                    data: {
                        create_date
                    },
        ...
        function get_item(tbl, tbody, tipe_dtl) {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formintwtd014_00/get_list_item/intwtd014/00",
                    dataType: "json",
                    data: {
                        tipe_dtl,
                        create_date
