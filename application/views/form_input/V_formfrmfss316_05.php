            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss316_05/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss316" name="formfrmfss316" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                                        ...
                                                        foreach ($dtdetail as $dtdetail_row) { 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    ...
                                                                    <input type="<?=$type?>" name="nama_jenis_air[]" id="nama_jenis_air" class="nama_jenis_air form-control w-auto" style="text-align: center;" value="<?= $dtdetail_row->nama_jenis_air ?>" required readonly>
                                                                </td>

                                                                <td align="center"><input type="<?=$type?>" name="nama_departemen[]" id="nama_departemen" class="nama_departemen form-control w-auto" style="text-align: center;" size="10" value="<?= $dtdetail_row->nama_departemen ?>" required readonly>
                                                                <td align="center"><input type="<?=$type?>" name="nama_flow[]" id="nama_flow" class="nama_flow form-control w-auto" style="text-align: center;" value="<?= $dtdetail_row->nama_flow ?>" required readonly>
                                                                <td align="center"><input type="<?=$type?>" name="fm_awal[]" id="fm_awal" class="fm_awal angkadantitik form-control w-auto" style="text-align: center;" size="10" value="<?= $dtdetail_row->fm_awal ?>">
                                                                <td align="center"><input type="<?=$type?>" name="fm_akhir[]" id="fm_akhir" class="fm_akhir angkadantitik form-control w-auto" style="text-align: center;" size="10" value="<?= $dtdetail_row->fm_akhir ?>">
                                                                <td align="center"><input type="<?=$type?>" name="total[]" id="total" class="total form-control w-auto" style="text-align: center;" size="10" value="<?= $dtdetail_row->total ?>" required readonly>
                                                                <td align="center"><input type="<?=$type?>" name="ket[]" id="ket" class="ket form-control w-auto" style="text-align: center;" size="10" value="<?= $dtdetail_row->ket ?>"></td>
                                                            </tr>
                                                    <?php }
                                                    } ?>
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss316_05/get_docno/frmfss316/05",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_list_dept_pemakaian_air() {
            ...
            if (typeof(input_headerid) == "undefined" && tgl != '' && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss316_05/get_list_dept_pemakaian_air/frmfss316/05",
                    data: {
                        tgl,
                        create_date
                    },
