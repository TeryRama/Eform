            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss061_03/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss061" name="formfrmfss061" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                    ...
                                    <!-- <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select name="gugus" id="gugus" class="form-control gugus select2 dtopen_blok2" required>
                                                ...
                                                <option value="Sedimen" <?= isset($headerid) ?? $gugus == 'Sedimen' ? 'selected' : ''; ?>>Sedimen</option>
                                                <option value="WTD Lama" <?= isset($headerid) ?? $gugus == 'WTD Lama' ? 'selected' : ''; ?>>WTD Lama</option>
                                                <option value="WTD Baru" <?= isset($headerid) ?? $gugus == 'WTD Baru' ? 'selected' : ''; ?>>WTD Baru</option>
                                            </select>
                                        </div>
                                    </div> -->
                                    <div class="form-group row">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="table-primary align-middle text-center" rowspan="2">Jenis Oli/ Grease</th>
                                                        <th class="table-primary align-middle text-center" rowspan="2">Volume (L/Kg)</th>
                                                        <th class="table-primary align-middle text-center" rowspan="2">Frekuensi ( Jam)</th>
                                                ...
                                                <tbody id="tbody">
                                                    <?php if (isset($dtdetail)) {
                                                        ...
                                                        foreach ($dtdetail as $dtdetail_row) { ?>
                                                            <tr>
                                                                ...
                                                                <td align="center"><select name="dtl_a_nama_mesin[]" id="dtl_a_nama_mesin" class="dtl_a_nama_mesin form-control w-auto">
                                                                    <option value="">- Pilih -</option>
                                                                ...
                                                                <td align="center"><select name="dtl_a_kode_mesin[]" id="dtl_a_kode_mesin" class="dtl_a_kode_mesin form-control w-auto">
                                                                    <option value="">- Pilih -</option>
                                                                    <option value="<?= $dtdetail_row->kode_mesin ?>" selected><?= $dtdetail_row->kode_mesin ?></option>
                                                                </select></td>
                                                                <td align="center"><input type="text" name="dtl_a_jenis_oli[]" id="dtl_a_jenis_oli" class="dtl_a_jenis_oli form-control w-auto" size="15" value="<?= $dtdetail_row->jenis_oli ?>"></td>
                                                                <td align="center"><input type="text" name="dtl_a_volume[]" id="dtl_a_volume" class="dtl_a_volume form-control w-auto" size="15" value="<?= $dtdetail_row->volume ?>"></td>
                                                                <td align="center"><input type="text" name="dtl_a_frekuensi[]" id="dtl_a_frekuensi" class="dtl_a_frekuensi form-control w-auto" size="15" value="<?= $dtdetail_row->frekuensi ?>"></td>
                                                                <?php if(isset($list_month)){
                                                                    foreach ($list_month as $list_month_row) { ?>
                                                                        <td align="centar"
                                                                            <?php 
                                                    ...
                                                    <?php }
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center"><input type="text" name="dtl_a_oli[]" id="dtl_a_oli" class="dtl_a_oli form-control w-auto" size="15" value="" readonly></td>
                                                                <td align="center"><input type="text" name="dtl_a_jenis_oli[]" id="dtl_a_jenis_oli" class="dtl_a_jenis_oli form-control w-auto" size="15" value=""></td>
                                                                <td align="center"><input type="text" name="dtl_a_volume[]" id="dtl_a_volume" class="dtl_a_volume form-control w-auto" size="15" value=""></td>
                                                                <td align="center"><input type="text" name="dtl_a_frekuensi[]" id="dtl_a_frekuensi" class="dtl_a_frekuensi form-control w-auto" size="15" value=""></td>
                                                                <?php if(isset($list_month)){
                                                                    foreach ($list_month as $list_month_row) { ?>
                                                                        <td align="centar"><input type="text" name="<?= 'month'.$list_month_row->month ?>[]" id="<?= 'month'.$list_month_row->month ?>" size="12" class="form-control w-auto datepicker maskdate <?= 'month'.$list_month_row->month ?>" value=""></td>
                                                                <?php }
                                                                } ?>
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss061_03/get_docno/frmfss061/03",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_mesin_frmfss064() {
            ...
            if (dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss061_03/get_mesin_frmfss064/frmfss061/03",
                    data: {
                        dept
                    },
                    async: false,
                        ...
                        if(data.status==0){
                            $.each(data.data, function(key, dtl_val) {
                                opt += `<tr>
                                            ...
                                            <td align="center"><input type="text" name="dtl_a_oli[]" id="dtl_a_oli" class="dtl_a_oli form-control w-auto" size="15" value="`+dtl_val.oli+`" readonly></td>
                                            <td align="center"><input type="text" name="dtl_a_jenis_oli[]" id="dtl_a_jenis_oli" class="dtl_a_jenis_oli form-control w-auto" size="15" value=""></td>
                                            <td align="center"><input type="text" name="dtl_a_volume[]" id="dtl_a_volume" class="dtl_a_volume form-control w-auto" size="15" value=""></td>
                                            <td align="center"><input type="text" name="dtl_a_frekuensi[]" id="dtl_a_frekuensi" class="dtl_a_frekuensi form-control w-auto" size="15" value=""></td>
                                            <?php if(isset($list_month)){
        ...
        $(document).on('change', '.dtl_a_nama_mesin', function() {
            var that = $(this);
            ...
            if (dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss061_03/get_kode_frmfss064/frmfss061/03",
                    data: {
                        dept,
                        nama_mesin
                    },
                    ...
                    success: function(data) {
                        ...
                        if(data.status==0){
                            ...
                            that.closest('tr').find('[class*=dtl_a_kode_mesin]').find('option:not(:first)').remove();
                            that.closest('tr').find('[class*=dtl_a_kode_mesin]').append(opt);
                        }
                        if(data.status==0){
                            $.each(data.data, function(key, dtl_val) {
                                ol = '<input type=`text` value="' + dtl_val.oli + '">' + dtl_val.oli + '</input>';
                            })
                            that.closest('tr').find('[class*=dtl_a_oli]').find('option:not(:first)').remove();
                            that.closest('tr').find('[class*=dtl_a_oli]').append(opt);
                        }
                    }
                });
            }
            if($(this).val()!=''){
                $('.dtl_a_frekuensi').trigger('change');
            }
        });
        ...
        $(document).on('click', '#add_sch', function() {
            ...
            if (dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss061_03/get_add_sch/frmfss061/03",
                    data: {
                        headerid,
                        tahun,
                        dept,
                    ...
                    success: function(data) {
                        ...
                        if(data.status == 0){
                            $('#myModalLabel').empty().append('Edit Month Schedule')
                                ...
                                if(data.data){
                                    list_td = '';
                                    $.each(data.data, function(key, list_dtl_row) { nocek++;
        ...
        $('#btnmodal_save').click(function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>index.php/form_input/C_formfrmfss061_03/save_modal_schedule/frmfss061/03",
                        type: 'POST',
                        dataType: 'json',
                        ...
                        success: function(data) {
                            ...
                            if(data.vstatus == 'success'){
                                Swal.fire(
                                    ...
                                    window.location.href = baseurl + 'index.php/form_input/C_formfrmfss061_03/form/frmfss061/03/dtopen/' + data.headerid;
                                });
                            }
                        },
                        error: function() {
