            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss317_14/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss317" name="formfrmfss317" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                            ...
                                            <table class="table table-bordered">
                                                    ...
                                                    ?>
                                                            ...
                                                            <?php if ($dtdetail_row->no_urut_desc == '1') { ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="table-secondary align-middle text-center dtl_a_total_persen"><?= $dtl_a_total_persen != "" ?? number_format($dtl_a_total_persen, 1) ?></td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td class="table-primary align-middle text-center dtl_a_grand_total_persen" rowspan="1" colspan="1"><?= $dtl_a_grand_total_persen != "" ?? number_format($dtl_a_grand_total_persen, 1) ?></td>
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <input type="hidden" class="dtl_f_total_awal" value="<?= $total_dtl_f_operasi_nilai_awal ?>">
...
<script>
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss317_14/get_docno/frmfss317/14",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_forminput() {
            ...
            if (create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss317_14/get_forminput/frmfss317/14",
                    data: {
                        create_date
                    },
                    dataType: "json",
                        ...
                        if (result.status == 0) {
                            ...
                            if (result.data.result_frmfss315.length && result.data.result_frmfss316.length && result.data.result_frmfss317.length) {
                                if (result.data.result_frmfss317[0].dtl_b_wtd_akumulatif != null) {
                                    list_dtl_b += `<tr>
                                                        <input type="hidden" name="dtl_b_operasi_jenis[]" id="dtl_b_operasi_jenis" class="dtl_b_operasi_jenis form-control w-auto" style="text-align: center;" value="Pemakaian WTD">                                    
                                                        ...
                                                        <td align="center">1</td>
                                                        <td align="center">Pemakaian WTD</td>
                            ...
                            if (result.data.result_frmfss315.length && result.data.result_frmfss520.length) {
                                ...
                                list_dtl_f += `<tr>
                                                        <input type="hidden" name="dtl_f_operasi_jenis[]" id="dtl_f_operasi_jenis" class="dtl_f_operasi_jenis form-control w-auto" style="text-align: center;" value="Konservasi Energi">                                    
                                                        <input type="hidden" name="dtl_f_operasi_satuan[]" id="dtl_f_operasi_satuan" class="dtl_f_operasi_satuan form-control w-auto" style="text-align: center;" value="` + result.data.result_frmfss520[0].reject_satuan + `">
                                                        <td align="center">` + (list_dtl_f_item.length + 2) + `</td>
                                                        <td align="center">Konservasi Energi</td>
                                                        <td align="center"><input type="text" name="dtl_f_operasi_nilai[]" id="dtl_f_operasi_nilai" class="dtl_f_operasi_nilai form-control w-auto angkadantitik hitung_total" style="text-align: center;" value="0"></td>
                                                        <td align="center">` + result.data.result_frmfss520[0].reject_satuan + `</td>
                                                        </tr>`;
                                dtl_f_total += parseFloat(result.data.result_frmfss520[0].reject_nilai);
                                dtl_f_total_awal += parseFloat(result.data.result_frmfss520[0].reject_nilai);
                            }

                            $('.dtl_f_total').empty().append(dtl_f_total.toFixed(1));
                            $('.dtl_f_total_awal').val(dtl_f_total_awal.toFixed(1));
    ...
    function dtl_f_operasi_nilai_konservasi_energi() {
        $('.dtl_f_operasi_nilai').keyup(function() {
            ...
            let val_total_f = $('.dtl_f_total').text();
            let val_total_f_awal = $('.dtl_f_total_awal').val();

            let val_dtl_g_stok_air_akhir = $('.dtl_g_stok_air_akhir').val();
            let val_dtl_g_stok_air_akhir_awal = $('.dtl_g_stok_air_akhir_awal').val();

            let total_f = parseFloat(isNaN(val_total_f) ? val_total_f_awal : val_total_f);
            let val_stok_akhir_recycle = ((parseFloat(val_dtl_g_stok_air_akhir_awal) - parseFloat(val_total_f_awal)) + parseFloat(total_f));
    ...
    function hitung_total(id) {
        ...
        if (total != 0) {
            $('.dtl_f_total').empty().append((total).toFixed(1));
        } else {
            $('.dtl_f_total').empty().append('0');
        }
    }
    // total dtl g 
