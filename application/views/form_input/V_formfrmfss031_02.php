            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss031_02/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss031" name="formfrmfss031" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="table-primary align-middle text-center" rowspan="2">Nama Mesin/Bagian Mesin</th>
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss031_02/get_docno/frmfss031/02",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        $(document).on('change', '.dept', function() {
            ...
            if (dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss031_02/get_nama_mesin/frmfss031/02",
                    data: {
                        dept
                    },
                    async: false,
        ...
        $(document).on('change', '.nama_mesin', function() {
            ...
            if (nama_mesin != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss031_02/get_kode_mesin/frmfss031/02",
                    data: {
                        nama_mesin
                    },
                    async: false,
        ...
        $(document).on('change', '.kode_mesin', function(){
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss031_02/get_partkomponen/frmfss031/02",
                data: {
                    deptabbr,
                    nama_mesin,
                    kode_mesin
