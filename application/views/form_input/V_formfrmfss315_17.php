            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss315_17/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss315" name="formfrmfss315" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                ...
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss315_17/get_docno/frmfss315/17",
                    dataType: "json",
                    data: {
                        create_date,
                    },
        ...
        function get_item() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss315_17/get_list_item/frmfss315/17",
                    dataType: "json",
                    data: {
                        create_date
                    },
