            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss065_03/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss065" name="formfrmfss065" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss065_03/get_docno/frmfss065/03",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_mesin_frmfss064() {
            ...
            if (dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss065_03/get_mesin_frmfss064/frmfss065/03",
                    data: {
                        dept
                    },
                    async: false,
        ...
        function get_frmfss060() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '' && dept != '' && nama_mesin != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss065_03/get_frmfss060/frmfss065/03",
                    data: {
                        create_date,
                        dept,
                        nama_mesin
                        ...
                        if (result.status == 0) {
                            if (result.data.length) {
                                ...
                                $.each(result.data, function(key, dtl_val) {
                                    list_dtl_a += `<tr>
                                                        <td><input type="checkbox" name="dtl_a_chk[]" id="dtl_a_chk" class="dtl_a_chk" value=""></td>
