            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss316_07/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss316" name="formfrmfss316" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss316_07/get_docno/frmfss316/07",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_list_dept_pemakaian_air() {
            ...
            if (typeof(input_headerid) == "undefined" && tgl != '' && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss316_07/get_list_dept_pemakaian_air/frmfss316/07",
                    data: {
                        tgl,
                        create_date
                    },
