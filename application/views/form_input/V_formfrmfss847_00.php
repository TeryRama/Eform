            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss847_00/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss061" name="formfrmfss061" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <thead id="thead" style="position:sticky;top: 0; z-index: 1;">
                                                    <tr>
                                                        ...
                                                        <th class="fixed freeze_horizontal table-primary align-middle text-center" rowspan="2">Nama Komponen</th>
                                                        <th class="fixed freeze_horizontal table-primary align-middle text-center" rowspan="2">Code
                                                        </th>
                                                        <th class="fixed freeze_horizontal table-primary align-middle text-center" rowspan="2">Status</th>
                                                        <th class="table-primary align-middle text-center" rowspan="2">Suhu</th>
                                                        <th class="table-primary align-middle text-center" rowspan="2">Bersih</th>
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss847_00/get_docno/frmfss847/00",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_jenis_mesin_by(dept) {
            ...
            if (typeof(input_headerid) == "undefined" && dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss847_00/get_jenis_mesin_by/frmfss847/00",
                    data: {
                        dept,
                        create_date
                    },
        ...
        function get_gugus_by(id_jns_mesin) {
            ...
            if (typeof(input_headerid) == "undefined" && dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss847_00/get_gugus_by/frmfss847/00",
                    data: {
                        dept,
                        create_date,
                        id_jns_mesin
        ...
        function get_itemmesin(id_gugus) {
            ...
            if (typeof(input_headerid) == "undefined" && dept != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss847_00/get_itemmesin/frmfss847/00",
                    data: {
                        dept,
                        create_date,
                        id_jns_mesin,
                        ...
                        if (result.status == 0) {
                            ...
                            if (result.data.length) {
                                ...
                                list_thead_mesin += `<tr>
                                                        ...
                                                        <th class="table-primary align-middle text-center" rowspan="2">Code
                                                        </th>
                                                        <th class="table-primary align-middle text-center" rowspan="2">Status</th>`;
                                ...
                                //     });
                                // });
                                list_thead_mesin += `<th class="table-primary align-middle text-center" rowspan="2">Suhu</th>
                                                        <th class="table-primary align-middle text-center" rowspan="2">Bersih</th>
                                                        <th class="table-primary align-middle text-center" rowspan="1" colspan="2">Insperktor</th>
                                                        <th class="table-primary align-middle text-center" rowspan="2">Keterangan</th>
                                                    </tr>
                                                    <tr>
                                                        <th class="table-primary align-middle text-center" rowspan="1">Nama</th>
