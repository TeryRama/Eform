            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss317_15/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss317" name="formfrmfss317" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss317_15/get_docno/frmfss317/15",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_forminput() {
            ...
            if (create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss317_15/get_forminput/frmfss317/15",
                    data: {
                        create_date,
                        persen
                    },
