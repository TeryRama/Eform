            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss315_18/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss315" name="formfrmfss315" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="table-responsive scrolly_table" id="<?= 'scrolling_table_cone_' . $i ?>" style="max-height: 800px;">
                                                                <table class="table table-striped table-bordered">
                                                                    <thead class="table-primary">
                                                                        <tr>
                                                                            <th class="table-primary align-middle text-center" colspan="5">Proses Cone</th>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card collapse-icon accordion-icon-rotate">
                                        <div class="accordion" id="accordion_dtl_c">
                                                            ...
                                                            <div class="table-responsive scrolly_table" id="<?= 'scrolling_table_bsf_' . $i ?>" style="max-height: 800px;">
                                                                <table class="table table-striped table-bordered">
                                                                    <thead id="<?= 'thead_dtl_c_bsf_' . $i ?>" class="table-warning">
                                                                        ...
                                                                        <tr>
                                                                            <th class="table-warning align-middle text-center" rowspan="1" colspan="1">C1 (1080)</th>
                                            ...
                                            <?php if (isset($remark)) { ?>
                                                <textarea name="remark" id="remark" cols="50" rows="0"><?= $remark  ?></textarea>
                                            <?php } else { ?>
                                                <textarea name="remark" id="remark" cols="50" rows="0"></textarea>
                                            <?php } ?>
                                        </div>
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                ...
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss315_18/get_docno/frmfss315/18",
                    dataType: "json",
                    data: {
                        create_date,
                    },
        ...
        function get_item() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss315_18/get_list_item/frmfss315/18",
                    dataType: "json",
                    data: {
                        create_date
                    },
