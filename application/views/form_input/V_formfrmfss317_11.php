            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss317_11/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss317" name="formfrmfss317" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                                ...
                                                <tbody id="tbody_dtl_a">
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <?php
                                                                if ($dtdetail_row->nama_departemen == 'WTD') { ?>
                                                                    <td align="center"><input type="text" name="dtl_a_pemakaian[]" id="dtl_a_pemakaian" class="dtl_a_pemakaian angkadantitik form-control w-auto" style="text-align: center;" value="<?= $dtdetail_row->pemakaian ?>" required></td>
                                                                    <td align="center"><input type="text" name="dtl_a_persen[]" id="dtl_a_persen" class="dtl_a_persen angkadantitik form-control w-auto" style="text-align: center;" value="<?= $dtdetail_row->persen ?>" required readonly></td>
                                                                    <td align="center"><input type="text" name="dtl_a_akumulatif[]" id="dtl_a_akumulatif" class="dtl_a_akumulatif angkadantitik form-control w-auto" style="text-align: center;" value="<?= $dtdetail_row->akumulatif ?>" required readonly></td>
                                                                <?php
                                                                } else { ?>
                                                                    ...
                                                                    <td align="center"><input type="text" name="dtl_a_persen[]" id="dtl_a_persen" class="dtl_a_persen form-control w-auto" style="text-align: center;" value="<?= $dtdetail_row->persen ?>" required readonly></td>
                                                ...
                                                <tbody id="tbody_dtl_g">
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td align="center"><input type="text" name="dtl_g_stok_air_akhir[]" id="dtl_g_stok_air_akhir" class="dtl_g_stok_air_akhir form-control w-auto" style="text-align: center;" value="<?= $dtdetail_row_g->stok_air_akhir ?>" required readonly></td>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th class="table-success align-middle text-center" rowspan="1" colspan="1">Drain Sedimen (M3)</th>
                                                        <th class="table-success align-middle text-center" rowspan="1" colspan="1">Backwash Tanki (M3)</th>
                                                        <th class="table-success align-middle text-center" rowspan="1" colspan="1">Cleaning Bak (M3)</th>
                                                        <th class="table-success align-middle text-center" rowspan="1" colspan="1">Operasional/Cleaning WTD (M3)</th>
                                                    </tr>
                                                </thead>
...
<script>
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss317_11/get_docno/frmfss317/11",
                    data: {
                        create_date
                    },
                    async: false,
        ...
        function get_forminput() {
            var input_headerid = $(".headerid").val();
            var create_date = $('.create_date').val();
            // console.log(input_headerid);
            if (create_date != '' && input_headerid == undefined) {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss317_11/get_forminput/frmfss317/11",
                    data: {
                        create_date
                    },
                    dataType: "json",
                    ...
                    success: function(result) {
                        if (result.status == 0) {
                            ...
                            if (result.data.result_frmfss316.length) {
                                ...
                                $.each(result.data.result_frmfss316, function(dtl_a_key, dtl_a_row) {
                                    ...
                                    list_dtl_a += `<tr>
                                                    ...
                                                    <td align="center"><input type="text" name="dtl_a_persen[]" id="dtl_a_persen" class="dtl_a_persen form-control w-auto" style="text-align: center;" value="` + parseFloat(dtl_a_row.persen).toFixed(1) + `" required readonly></td>
                                ...
                                for (let dtl_b_i = 0; dtl_b_i < list_dtl_b_item.length; dtl_b_i++) {
                                    if (list_dtl_b_item[dtl_b_i] == 'dtl_b_air_gambut_total') {
                                        ...
                                        list_dtl_b += `<tr>
                                                        ...
                                                        <td align="center"><input type="text" name="dtl_b_operasi_akumulatif[]" id="dtl_b_operasi_akumulatif" class="dtl_b_operasi_akumulatif form-control w-auto" style="text-align: center;" value="` + parseFloat(result.data.result_frmfss315[0][list_dtl_b_item[dtl_b_i] + '_akumulatif']).toFixed(1) + `" required></td>
                            ...
                            if (result.data.result_frmfss315.length && result.data.result_frmfss316.length && result.data.result_frmfss317.length) {
                                if (result.data.result_frmfss317[0].dtl_b_wtd_akumulatif != null) {
                                    list_dtl_b += `<tr>
                                                        <input type="hidden" name="dtl_b_operasi_jenis[]" id="dtl_b_operasi_jenis" class="dtl_b_operasi_jenis form-control w-auto" style="text-align: center;" value="WTD">                                    
                                                        <input type="hidden" name="dtl_b_operasi_satuan[]" id="dtl_b_operasi_satuan" class="dtl_b_operasi_satuan form-control w-auto" style="text-align: center;" value="` + result.data.result_frmfss317[0].dtl_b_wtd_satuan + `">
                                                        <td align="center">1</td>
                                                        <td align="center">WTD</td>
                                                        <td align="center"><input type="text" name="dtl_b_operasi_nilai[]" id="dtl_b_operasi_nilai" class="dtl_b_operasi_nilai_wtd form-control w-auto angkadantitik" style="text-align: center;" value="` + parseFloat(result.data.result_frmfss317[0].dtl_b_wtd_nilai).toFixed(1) + `"  ></td>
                                                        <td align="center">
                                                            <input type="text" name="dtl_b_operasi_akumulatif[]" id="dtl_b_operasi_akumulatif_hasil" class="dtl_b_operasi_akumulatif_hasil form-control w-auto" style="text-align: center;" value="` + parseFloat(result.data.result_frmfss317[0].dtl_b_wtd_akumulatif).toFixed(1) + `" required >
                                                            <input type="hidden" id="dtl_b_operasi_akumulatif" class="dtl_b_operasi_akumulatif form-control w-auto" style="text-align: center;" value="` + parseFloat(result.data.result_frmfss317[0].dtl_b_wtd_akumulatif).toFixed(1) + `" required >
                                                        </td>
                                                        <td align="center">` + result.data.result_frmfss317[0].dtl_b_wtd_satuan + `</td>
                                                    </tr>`;
                                } else {

                                    list_dtl_b += `<tr>
                                                            <input type="hidden" name="dtl_b_operasi_jenis[]" id="dtl_b_operasi_jenis" class="dtl_b_operasi_jenis form-control w-auto" style="text-align: center;" value="WTD">                                    
                                                            <input type="hidden" name="dtl_b_operasi_satuan[]" id="dtl_b_operasi_satuan" class="dtl_b_operasi_satuan form-control w-auto" style="text-align: center;" value="M3">
                                                            <td align="center">1</td>
                                                            <td align="center">WTD</td>
                                                            <td align="center"><input type="text" name="dtl_b_operasi_nilai[]" id="dtl_b_operasi_nilai" class="dtl_b_operasi_nilai_wtd form-control w-auto angkadantitik" style="text-align: center;" value="0"></td>
                                                            <td align="center"><input type="text" name="dtl_b_operasi_akumulatif[]" id="dtl_b_operasi_akumulatif" class="dtl_b_operasi_akumulatif_wtd form-control w-auto" style="text-align: center;" value="0" required ></td>
                                                            <td align="center">M3</td>
                                                        </tr>`;
                                }
                            }

                            // $('.dtl_b_total_operasi_nilai').empty().append(parseFloat(dtl_b_total_operasi_nilai).toFixed(1));
                            // $('.dtl_b_total_operasi_akumulatif').empty().append(parseFloat(dtl_b_total_operasi_akumulatif).toFixed(1));
                            // $('.dtl_b_total_operasi_satuan').empty().append(dtl_b_total_operasi_satuan);
                            ...
                            if (result.data.result_frmfss520.length) {
                                ...
                                for (let dtl_c_i_uf = 0; dtl_c_i_uf < list_dtl_c_uf_item.length; dtl_c_i_uf++) {
                                    list_dtl_c_uf += `<tr>
                                                        <input type="hidden" name="dtl_c_operasi_jenis[]" id="dtl_c_operasi_jenis" class="dtl_c_operasi_jenis form-control w-auto" style="text-align: center;" value="` + result.data.result_frmfss520[0][list_dtl_c_uf_item[dtl_c_i_uf] + '_jenis'] + `">                                    
                                                        <input type="hidden" name="dtl_c_operasi_satuan[]" id="dtl_c_operasi_satuan" class="dtl_c_operasi_satuan form-control w-auto" style="text-align: center;" value="` + result.data.result_frmfss520[0][list_dtl_c_uf_item[dtl_c_i_uf] + '_satuan'] + `">
                                                        <input type="hidden" name="dtl_c_operasi_status[]" id="dtl_c_operasi_status" class="dtl_c_operasi_status form-control w-auto" style="text-align: center;" value="` + result.data.result_frmfss520[0]['tabel_uf_status'] + `">
                                                        <td align="center">` + (dtl_c_i_uf + 1) + `</td>
                                                        <td align="center">` + result.data.result_frmfss520[0][list_dtl_c_uf_item[dtl_c_i_uf] + '_jenis'] + `</td>
                                                        <td align="center"><input type="text" name="dtl_c_operasi_nilai[]" id="dtl_c_operasi_nilai" class="dtl_c_operasi_nilai form-control w-auto" style="text-align: center;" value=""></td>
                                                        <td align="center"><input type="text" name="dtl_c_operasi_akumulatif[]" id="dtl_c_operasi_akumulatif" class="dtl_c_operasi_akumulatif form-control w-auto" style="text-align: center;" value=""></td>
                                                        <td align="center">` + result.data.result_frmfss520[0][list_dtl_c_uf_item[dtl_c_i_uf] + '_satuan'] + `</td>
                                                    </tr>`;
                            ...
                            // tambahan list reject dari frmfss520
                            if (result.data.result_frmfss315.length && result.data.result_frmfss520.length) {
                                list_dtl_e += `<tr>
                                                    <input type="hidden" name="dtl_e_operasi_jenis[]" id="dtl_e_operasi_jenis" class="dtl_e_operasi_jenis form-control w-auto" style="text-align: center;" value="Recycle Ex Filter">                                    
                                                    <input type="hidden" name="dtl_e_operasi_satuan[]" id="dtl_e_operasi_satuan" class="dtl_e_operasi_satuan form-control w-auto" style="text-align: center;" value="` + result.data.result_frmfss520[0].reject_satuan + `">
                                                    <td align="center">` + (list_dtl_e_item.length + 1) + `</td>
                                                    <td align="center">Recycle Ex Filter</td>
                                                    <td align="center"><input type="text" name="dtl_e_operasi_nilai[]" id="dtl_e_operasi_nilai" class="dtl_e_operasi_nilai form-control w-auto" style="text-align: center;" value="` + parseFloat(result.data.result_frmfss520[0].reject_nilai).toFixed(1) + `" required></td>
                                                    <td align="center"><input type="text" name="dtl_e_operasi_akumulatif[]" id="dtl_e_operasi_akumulatif" class="dtl_e_operasi_akumulatif form-control w-auto" style="text-align: center;" value="` + parseFloat(result.data.result_frmfss520[0].reject_akumulatif).toFixed(1) + `" required></td>
                                                    <td align="center">` + result.data.result_frmfss520[0].reject_satuan + `</td>
                                                </tr>`;
                                dtl_e_total_operasi_nilai += parseFloat(result.data.result_frmfss520[0].reject_nilai);
                                dtl_e_total_operasi_akumulatif += parseFloat(result.data.result_frmfss520[0].reject_akumulatif);
                            ...
                            // dtl f
                            const list_dtl_f_item = ['dtl_f_asf', 'dtl_f_acf', 'dtl_f_ast'];
                            let dtl_f_total = 0;
                            ...
                            if (result.data.result_frmfss315.length) {
                                for (let dtl_f_i = 0; dtl_f_i < list_dtl_f_item.length; dtl_f_i++) {
                                    list_dtl_f += `<tr>
                                                        <input type="hidden" name="dtl_f_operasi_jenis[]" id="dtl_f_operasi_jenis" class="dtl_f_operasi_jenis form-control w-auto" style="text-align: center;" value="` + result.data.result_frmfss315[0][list_dtl_f_item[dtl_f_i] + '_jenis'] + `">                                    
                                                        <input type="hidden" name="dtl_f_operasi_satuan[]" id="dtl_f_operasi_satuan" class="dtl_f_operasi_satuan form-control w-auto" style="text-align: center;" value="` + result.data.result_frmfss315[0][list_dtl_f_item[dtl_f_i] + '_satuan'] + `">
                                                        <td align="center">` + (dtl_f_i + 1) + `</td>
                                                        <td align="center">` + result.data.result_frmfss315[0][list_dtl_f_item[dtl_f_i] + '_jenis'] + `</td>
                                                        <td align="center"><input type="text" name="dtl_f_operasi_nilai[]" id="dtl_f_operasi_nilai" class="dtl_f_operasi_nilai form-control w-auto angkadantitik" style="text-align: center;" value="0"></td>
                                                        <td align="center">` + result.data.result_frmfss315[0][list_dtl_f_item[dtl_f_i] + '_satuan'] + `</td>
                                                        </tr>`;
                                }
                            }
                            if (result.data.result_frmfss315.length && result.data.result_frmfss520.length) {
                                list_dtl_f += `<tr>
                                                        <input type="hidden" name="dtl_f_operasi_jenis[]" id="dtl_f_operasi_jenis" class="dtl_f_operasi_jenis form-control w-auto" style="text-align: center;" value="Reject RO">                                    
                                                        <input type="hidden" name="dtl_f_operasi_satuan[]" id="dtl_f_operasi_satuan" class="dtl_f_operasi_satuan form-control w-auto" style="text-align: center;" value="` + result.data.result_frmfss520[0].reject_satuan + `">
                                                        <td align="center">` + (list_dtl_f_item.length + 1) + `</td>
                                                        <td align="center">Reject RO</td>
                                                        <td align="center"><input type="text" name="dtl_f_operasi_nilai[]" id="dtl_f_operasi_nilai" class="dtl_f_operasi_nilai form-control w-auto angkadantitik" style="text-align: center;" value="` + parseFloat(result.data.result_frmfss520[0].reject_nilai).toFixed(1) + `"></td>
                                                        <td align="center">` + result.data.result_frmfss520[0].reject_satuan + `</td>
                                                        </tr>`;
                                dtl_f_total += parseFloat(result.data.result_frmfss520[0].reject_nilai);
                            }

                            $('.dtl_f_total').empty().append(dtl_f_total.toFixed(1));
                            $('#tbody_dtl_f').empty().append(list_dtl_f);
                            // dtl f end

                            // dtl g
                            let list_dtl_g = `<tr>
                                                <td align="center"><input type="text" name="dtl_g_stok_air_akhir[]" id="dtl_g_stok_air_akhir" class="dtl_g_stok_air_akhir form-control w-auto" style="text-align: center;" value="` + dtl_e_total_operasi_nilai + `" required readonly></td>
                                                <td align="center"><input type="text" name="dtl_g_t_distribusi[]" id="dtl_g_t_distribusi" class="dtl_g_t_distribusi form-control w-auto" style="text-align: center;" value="` + dtl_a_grand_total_pemakaian + `" required readonly></td>
                                                ...
                                                <td align="center"><input type="text" name="dtl_g_total_proses[]" id="dtl_g_total_proses" class="dtl_g_total_proses form-control w-auto" style="text-align: center;" value="` + dtl_b_total_operasi_nilai + `" required readonly></td>
                                            </tr>`;
                            ...
                            if (result.data.result_frmfss315.length) {
                                ...
                                for (let dtl_i_i = 0; dtl_i_i < list_dtl_i_item.length; dtl_i_i++) {
                                    if (result.data.result_frmfss315[0][list_dtl_i_item[dtl_i_i] + '_jenis'] == 'Tawas (15%)') {
                                        ...
                                        dtl_i_effisiensi = ((parseFloat(result.data.result_frmfss315[0][list_dtl_i_item[dtl_i_i] + '_nilai']).toFixed(1) * 0.15) / parseFloat(result.data.result_frmfss315[0]['dtl_b_air_gambut_sedimen_nilai']).toFixed(1)).toFixed(2);
                                    } else if (result.data.result_frmfss315[0][list_dtl_i_item[dtl_i_i] + '_jenis'] == 'Caustic soda (10%)') {
                                        dtl_i_nilai = parseFloat(result.data.result_frmfss315[0][list_dtl_i_item[dtl_i_i] + '_nilai']).toFixed(1);
                                        dtl_i_effisiensi = ((parseFloat(result.data.result_frmfss315[0][list_dtl_i_item[dtl_i_i] + '_nilai']).toFixed(1) * 0.1) / parseFloat(result.data.result_frmfss315[0]['dtl_b_air_gambut_total_nilai']).toFixed(1)).toFixed(2);
                                    } else if (result.data.result_frmfss315[0][list_dtl_i_item[dtl_i_i] + '_jenis'] == 'ACH (15%)') {
                                        dtl_i_nilai = parseFloat(result.data.result_frmfss315[0][list_dtl_i_item[dtl_i_i] + '_nilai']).toFixed(1);
                                        dtl_i_effisiensi = ((parseFloat(result.data.result_frmfss315[0][list_dtl_i_item[dtl_i_i] + '_nilai']).toFixed(1) * 0.15) / parseFloat(result.data.result_frmfss315[0]['dtl_b_air_gambut_cone_nilai']).toFixed(1)).toFixed(2);
                                    }
                            ...
                            if (result.data.result_frmfss315.length) {
                                ...
                                for (let dtl_k_i = 0; dtl_k_i < list_dtl_k_item.length; dtl_k_i++) {
                                    console.log(result.data.result_frmfss315[0][list_dtl_k_item[dtl_k_i] + '_nilai']);
                            ...
                            const list_dtl_m_item = ['dtl_m_as', 'dtl_m_mcal', 'dtl_m_mcd'];
                            ...
                            const list_dtl_n_item = ['dtl_n_cf'];
                            ...
                            if (result.data.result_frmfss520.length) {
                                ...
                                list_dtl_o += `<tr>
                                                        ...
                                                        <input type="hidden" name="dtl_o_operasi_satuan[]" id="dtl_o_operasi_satuan" class="dtl_o_operasi_satuan form-control w-auto" style="text-align: center;" value="M3">
                                                        <td align="center">1</td>
                                                        <td align="center">Proses UF</td>
                                                        <td align="center"><input type="text" name="dtl_o_operasi_produk[]" id="dtl_o_operasi_produk" class="dtl_o_operasi_produk form-control w-auto" style="text-align: center;" value="" required></td>
                                                        <td align="center"><input type="text" name="dtl_o_operasi_jam[]" id="dtl_o_operasi_jam" class="dtl_o_operasi_jam form-control w-auto" style="text-align: center;" value="" required></td>
                                                        <td align="center">M3</td>
                                                     </tr>`;
                                list_dtl_o += `
                                                    <tr>
                                                        <td class="table-warning align-middle text-center" rowspan="1" colspan="2">Total</td>
                                                        <td class="table-warning align-middle text-center dtl_o_total_m3" rowspan="1" colspan="1"></td>
                                                        <td class="table-warning align-middle text-center dtl_o_total_jam" rowspan="1" colspan="1"></td>
                                                        <td class="table-warning align-middle text-center dtl_o_total_satuan" rowspan="1" colspan="1"></td>
                                                    </tr>`;
                            }
    ...
    function dtl_b_operasi_nilai() {
        $('.dtl_b_operasi_nilai_wtd').keyup(function() {
            ...
            // that.closest('tr').find('.dtl_b_operasi_akumulatif_hasil').val(hasil_akumulatif_wtd);
        ...
        // $('.dtl_b_operasi_nilai').change(function() {
        //     let that = $(this);
        //     let that_val = that.val();

        //     let dtcreate_date = $('#create_date').val();
        //     let val_date = dtcreate_date.split("-");

        //     let hasil_akumulatif_opr_jam = (that_val * val_date[0]).toFixed(1);
        //     that.closest('tr').find('.dtl_b_operasi_akumulatif').val(hasil_akumulatif_opr_jam);
        // });
    ...
    function dtl_g_cari_total_bawah() {
        let dtl_g_stok_air_akhir = $('#dtl_g_stok_air_akhir').val();
        let dtl_g_t_distribusi = $('#dtl_g_t_distribusi').val();
        let dtl_g_stok_air_awal = $('#dtl_g_stok_air_awal').val();
        let dtl_g_total_proses = $('#dtl_g_total_proses').val();

        let dtl_g_total_bawah = parseFloat(dtl_g_stok_air_akhir) + parseFloat(dtl_g_t_distribusi) - parseFloat(dtl_g_stok_air_awal) - parseFloat(dtl_g_total_proses);
