            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('form_input/C_formfrmfss520_11/form/' . $frmkd . '/' . $frmvrs . '/' . $aksi) ?>" id="formfrmfss520" name="formfrmfss520" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="row mb-1">
                                <div class="col-6">
                                                                                ...
                                                                                if ($dtdetail_row->shift == 'shift_' . $i) {         //perulangan kolom dishift dijadikan 1 kolom
                                                                                    ...
                                                                                    <tr class="<?= $tr_color ?>">
                                                                                        ...
                                                                                        for ($j = 1; $j <= 8; $j++) {  ?>
                                                                                            ...
                                                                                            <?php if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 1 ' && $dtdetail_row->kode == 'FM. 21') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg ?> tambah1" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php  } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 1 ' && $dtdetail_row->kode == 'FM. 22') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg ?> tambah2" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 1 ' && $dtdetail_row->kode == 'FW. 01') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg ?> total_tambah" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php   } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 1 ' && $dtdetail_row->kode == 'PRC') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg  ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg  ?> total_bagi" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 2' && $dtdetail_row->kode == 'FM. 23') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg  ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg  ?> tambah1" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 2' && $dtdetail_row->kode == 'FM. 24') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg  ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg  ?> tambah2" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 2' && $dtdetail_row->kode == 'FW. 02') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg  ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg  ?> total_tambah" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php   } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 2 ' && $dtdetail_row->kode == 'PRC') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg  ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg  ?> total_bagi" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 3 ' && $dtdetail_row->kode == 'FM. 25') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg  ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg  ?> tambah1" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php  } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 3 ' && $dtdetail_row->kode == 'FM. 26') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg  ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg  ?> tambah2" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php   } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 3 ' && $dtdetail_row->kode == 'FW. 03') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg  ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg  ?> total_tambah" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>

                                                                                            <?php   } else if ($dtdetail_row->nama_mesin = 'Reverse Osmosis 3 ' && $dtdetail_row->kode == 'PRC') { ?>
                                                                                                <td align="center"><input type="text" name="<?= 'dtl_cek_shift_jam' . $j ?>[]" id="hasil_<?= $alphabet[$j] ?>_shift_<?= $no2 . '_' . $no_bg  ?>" class="<?= 'form-control angkadantitik w-auto dtl_cek_shift_jam' . $j . ' hasil_' . $alphabet[$j] . '_shift_' . $no2 . '_' . $no_bg  ?> total_bagi" style="text-align: center;" value="<?= $dtdetail_row->{'cek_shift_jam' . $j} ?>"></td>
                                        ...
                                        <div class="col-2">
                                            <table class="table table-condensed table-borderless">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <th>PG : Pressure Gauge</th>
                                                    </tr>
                                                    <tr>
                                                        <th>DP : Dosing Pump</th>
                                                    </tr>
                                                    <tr>
                                                        <th>FM : Flow Meter</th>
                                                    </tr>
                                                    <tr>
                                                        <th>M3 : Meter kubik</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
                                        <div class="col-5">
                                            <table class="table table-condensed table-borderless">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <th>*a. Product turun 10-15% performa awal</th>
                                                    </tr>
                                                    <tr>
                                                        <th>*b. Reject naik 5-10% performa awal</th>
                                                    </tr>
                                                    <tr>
                                                        <th>*c. ∆P Pressure stage 1 dan stage 2 </br>dan recovery pressure naik 30% dari performa awal</th>
                                                    </tr>
                                                    <tr>
                                                        <th>*d. Maximum selisih pressure stage 2 </br>dan recovery pressure = 10 Bar, Max</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
                                                                ...
                                                                <table class="table table-striped table-bordered">
                                                                    <thead class="table-success ">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th class="table-success align-middle text-center">pH (> 12)</th>
                                                                            <th class="table-success align-middle text-center">Temp (40-45'C)</th>
                                                                            <th class="table-success align-middle text-center">pH (< 2)</th>
                                                                            <th class="table-success align-middle text-center">Temp (40-45'C)</th>
                                                                        </tr>
                                                                    </thead>
                                                                    ...
                                                                    <?php if (isset($dtdetail_d)) {
                                                                        foreach ($dtdetail_d as $dtdetail_row4) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="center"><input type="text" name="dtl_d_jam[]" id="dtl_d_jam" class="masktime form-control dtl_d_jam" style="text-align: center;" value="<?= $dtdetail_row4->jam ?>"></td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center"><input type="text" name="dtl_d_jam[]" id="dtl_d_jam" class="masktime form-control dtl_d_jam" style="text-align: center;" value=""></td>
    ...
    $(document).ready(function() {
        ...
        function get_docno() {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                ...
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss520_11/get_docno/frmfss520/11",
                    data: {
                        create_date
                    },
        ...
        function get_item(tbl, tbody, tipe_dtl) {
            ...
            if (typeof(input_headerid) == "undefined" && create_date != '') {
                $.ajax({
                    type: "post",
                    url: "<?= base_url(); ?>index.php/form_input/C_formfrmfss520_11/get_list_item/frmfss520/11",
                    dataType: "json",
                    data: {
                        tipe_dtl,
                        create_date
                                ...
                                if (result.data[key].children) {
                                    ...
                                    $.each(result.data[key].children, function(key2, children_row) {
                                        ...
                                        for (let j = 1; j <= 8; j++) {
                                            ...
                                            if (children_row.item2 == 'FM. 21') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` tambah1" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (children_row.item2 == 'FM. 22') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` tambah2" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (children_row.item2 == 'FW. 01') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` total_tambah" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (list_item_row.item1 == 'Reverse Osmosis 1 ' && children_row.item2 == 'PRC') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` total_bagi" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (children_row.item2 == 'FM. 23') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` tambah1" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (children_row.item2 == 'FM. 24') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` tambah2" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (children_row.item2 == 'FW. 02') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` total_tambah" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (list_item_row.item1 == 'Reverse Osmosis 2 ' && children_row.item2 == 'PRC') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` total_bagi" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (children_row.item2 == 'FM. 25') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` tambah1" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (children_row.item2 == 'FM. 26') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` tambah2" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (children_row.item2 == 'FW. 03') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` total_tambah" style="text-align: center;" value=""></td>
                                                        `;
                                            } else if (list_item_row.item1 == 'Reverse Osmosis 3 ' && children_row.item2 == 'PRC') {
                                                list_dtl += `
                                                        <td align="center"><input type="text" name="dtl_cek_shift_jam${j}[]" id="hasil_` + alphabet[j] + `_` + no2 + `" class="form-control angkadantitik w-auto dtl_cek_shift_jam${j} hasil_` + alphabet[j] + `_` + no2 + ` total_bagi" style="text-align: center;" value=""></td>
                                                        `;
                                            } else {
