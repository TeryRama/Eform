                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered complex-headers">
                                ...
                                foreach($dt_sign as $dt_sign_row){ $no++;
                                    ...
                                    $fcpath2   = str_replace('cmp/', '', FCPATH);

                                    if ($dt_sign_row->nama != '') {
                                        if (file_exists(FCPATH . 'assets/ttd/TD_NON_USER/' . $dt_sign_row->nama . '.png')) {
                                            $ttd_base_path = '<img src="' . $base_url2 . 'cmp/assets/ttd/TD_NON_USER/' . $dt_sign_row->nama . '.png" style="width:100; height:50px; background-size:100%;" alt="">';
                                            ...
                                            $ttd_base_path = '<img src="' . $base_url2 . 'cmp/assets/ttd/TD_NON_USER/' . $dt_sign_row->nama . '_0_0.jpg" style="width:100; height:50px; background-size:100%;" alt="">';
                                        }
                                        else {
                                            $ttd_base_path = '';
                                        }
