        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">DATA SUPPLIER STEAM</h4>
                </div>
                                    ...
                                    <?php if (!empty($list_data)) {
                                        ...
                                        foreach ($list_data as $list_data_row) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><?= $list_data_row->dept_steam ?></td>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        <span>Dept Steam</span>
                                    </div>
                                    <div class="col-md-8">
                                        <input type="text" name="mdl1_dept_steam" id="mdl1_dept_steam" class="form-control mdl1_dept_steam set_kosong" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-4">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.modal_forminput', function() {
            ...
            if ($(this).attr("name") == 'btn_update' && headerid != '') {
                $("#modal_form").attr("action", "<?= base_url('master/supplier/C_supplier_steam/form/update') ?>");
                $("#mdl1_headerid").val(headerid);

                $.ajax({
                    url: "<?= base_url(); ?>/master/supplier/C_supplier_steam/get_dt_update",
                    type: "post",
                    data: {
                        headerid
                    },
                    success: function(data) {
                        if (JSON.parse(data)['status'] == 0) {
                            $(".mdl1_dept_steam").val(JSON.parse(data)['data'][0].dept_steam);
                ...
                $("#modal_form").attr("action", "<?= base_url('master/supplier/C_supplier_steam/form/add') ?>");
                $("#mdl1_headerid").val('');
