                                    ...
                                    <table class="table table-bordered sticky-header">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="table-info align-middle text-center" rowspan="2">Nama Mesin</th>
                                                <th class="table-info align-middle text-center" rowspan="2">Kode Mesin</th>
                                                <th class="table-info align-middle text-center" rowspan="2">Tanggal</th></th>
                                                <th class="table-info align-middle text-center" rowspan="2">Waktu Kejadian</th>
                                                <th class="table-info align-middle text-center" rowspan="2">Durasi Kerusakan & Perbaikan (Jam)</th>
                                                <th class="table-info align-middle text-center" rowspan="2">Perbaikan</th>
                                                <th class="table-info align-middle text-center" rowspan="2">Analisa Sebab Kerusakan</th>
                                                <th class="table-info align-middle text-center" rowspan="2">Tindakan Koreksi & Pencegahan</th>
                                            ...
                                            if (!empty($dtdetail)) {
                                                ...
                                                foreach ($dtdetail as $dtdetail_row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center"><?= $dtdetail_row->waktu_start ?></td>
                                                        <td align="center"><?= $dtdetail_row->durasi ?></td>
                                                        <td align="center"><?= $dtdetail_row->perbaikan ?></td>
                                                        <td align="center"><?= $dtdetail_row->analisa ?></td>
