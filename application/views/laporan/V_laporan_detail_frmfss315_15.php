                    ...
                    <div class="col-md-12 d-flex justify-content-center mb-1">
                        <div class="col-md-2 content-center mt-1">
                            <table class="table table-condensed">
                                <tr>
                                    <td style="text-align:center; font-weight: bold;"><img src="<?= base_url('assets/images/Logo_PSG.gif') ?>" /></td>
                                </tr>
                            </table>
                        </div>
                                ...
                                <table class="table table-striped table-bordered sticky-header">
                                    <thead class="table-warning">
                                        ...
                                        <tr>
                                            ...
                                            <th class="table-warning align-middle text-center" rowspan="1" colspan="1">BY FM</th>
