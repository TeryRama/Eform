                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-center">
                                <div class="col-md-3 content-center mt-1">
                                    <table class="table table-condensed">
                                        <tr>
                                            <td style="text-align:left; font-weight: bold;">Nama <?= ucwords($item) ?></td>
                                    ...
                                    <table class="table table-bordered sticky-header">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="table-primary align-middle text-center" rowspan="2">Bagian <?= ucwords($item) ?></th>
