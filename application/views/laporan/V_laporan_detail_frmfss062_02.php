                            ...
                            <div class="col-md-3">
                                <table class="table table-condensed">
                                    <tr>
                                        ...
                                        <td style="text-align:left; font-weight: bold;">: <?= $deptabbr; ?></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align:left; font-weight: bold;">Periode</td>
                                        <td style="text-align:left; font-weight: bold;">: <?= $arr_bulan[(float)date("m", strtotime($create_date))] . ' ' . date("Y", strtotime($create_date)); ?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                                            ...
                                            <?php if (isset($dtdetail)) {
                                                ...
                                                foreach ($dtdetail as $dtdetail_row) { ?>
                                                    <tr>
                                                        ...
                                                        <td align="center"><?= date("d-m-Y", strtotime($dtdetail_row->tanggal)) ?></td>
                                                        <td align="center"><?= $dtdetail_row->total_operasi ?></td>
                                                        <td align="center"><?= $dtdetail_row->oli_jenis ?></td>
                                                        <td align="center"><?= $dtdetail_row->oli_jumlah ?></td>
