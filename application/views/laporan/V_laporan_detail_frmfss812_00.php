                                                    ...
                                                    foreach ($dtkomponenmesin as $dtkomponenmesin_row) {
                                                        foreach ($part_komponen as $part_komponen_row) {
                                                            if($dtkomponenmesin_row->komponen_id == $part_komponen_row){ ?>
                                                                <th class="table-info align-middle text-center" rowspan="2"><?= $dtkomponenmesin_row->nama_komponen ?></th>
                                                        <?php }
                                                        }
                                                    }
                                                ?>
                                                <th class="table-info align-middle text-center" rowspan="2">Jam operasi (jam)</th>
