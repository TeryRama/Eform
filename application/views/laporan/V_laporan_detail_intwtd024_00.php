                                ...
                                <div class="table-responsive scrolly_table">
                                    <table class="table table-bordered sticky-header">
                                        <thead>
                                            ...
                                            <tr>
                                                <th class="table-info align-middle text-center"><?= $NamaBulan ?></th>
                                                <?php
                                                $lastday = $day_date;
                                                for ($i = 1; $i <= $lastday; $i++) { ?>
                                            ...
                                            <tr>
                                                <th class="table-info align-middle text-center">Departemen Pemakai</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            for ($arr = 0; $arr < count($dtlaporan); $arr++) { ?>
                                                ...
                                                if ($no_urut_desc[$arr] == 1) { ?>
                                                    <tr class="bg-secondary">
                                                        <td align="center" colspan="3">Total <?= $nama_jenis_air[$arr]; ?></td>
                                                        <?php for ($arr2 = 0; $arr2 < $day_date; $arr2++) { ?>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td class="table-info align-middle text-center" colspan="3" align="center">Total</td>
                                                <?php
