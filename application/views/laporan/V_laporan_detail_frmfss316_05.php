                                                ...
                                                foreach ($dtdetail as $dtdetail_row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        if ($dtdetail_row->nama_jenis_air == "ASF" && $dtdetail_row->nama_departemen == "WTD" && $dtdetail_row->nama_flow == "WTD") {?>
                                                            <td align="center" hidden><?= $dtdetail_row->no_urut ?></td>
                                                        <td align="center" hidden><?= $dtdetail_row->nama_departemen ?></td>
                                                        <td align="center" hidden><?= $dtdetail_row->nama_flow ?></td>
                                                        <td align="center" hidden><?= $dtdetail_row->fm_awal ?></td>
                                                        <td align="center" hidden><?= $dtdetail_row->fm_akhir ?></td>
                                                        <td align="center" hidden><?= $dtdetail_row->total ?></td>
                                                        <td align="center" hidden><?= $dtdetail_row->ket ?></td>
                                                        <?php  }else{?>
