                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="tbody_dtl_a">
                                            ...
                                            $dtl_a_total_pemakaian = '';
                                            $dtl_a_total_persen = '';
                                            $dtl_a_total_akumulatif = '';
                                            if (isset($dtdetail)) {
                                                $no = 1;
                                                foreach ($dtdetail as $dtdetail_row) {
                                                    ...
                                                    $dtl_a_total_pemakaian = $dtdetail_row->no_urut2_asc == 1 ? $dtdetail_row->pemakaian : $dtl_a_total_pemakaian + $dtdetail_row->pemakaian;
                                                    $dtl_a_total_persen = $dtdetail_row->no_urut2_asc == 1 ? $dtdetail_row->persen : $dtl_a_total_persen + $dtdetail_row->persen;
                                                    $dtl_a_total_akumulatif = $dtdetail_row->no_urut2_asc == 1 ? $dtdetail_row->akumulatif : $dtl_a_total_akumulatif + $dtdetail_row->akumulatif;
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td align="center"><?= $dtdetail_row->persen ?></td>
                                                    ...
                                                    <?php if ($dtdetail_row->no_urut_desc == '1') { ?>
                                                        <tr class="bg-secondary">
                                                            ...
                                                            <td align="center"><?= $dtl_a_total_pemakaian ?></td>
                                                            <td align="center"><?= $dtl_a_total_persen ?></td>
                                                            <td align="center"><?= $dtl_a_total_akumulatif ?></td>
                                                        </tr>
                                                    <?php } ?>
                                            <?php
                                                }
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="table-info align-middle text-center dtl_g_total_bawah" rowspan="1" colspan="1"><?= $dtl_g_total_bawah ?></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
