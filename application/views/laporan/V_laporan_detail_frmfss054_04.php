                                    ...
                                    <table class="table table-bordered sticky-header">
                                        <thead style="position:sticky;top: 0; z-index: 1;">
                                            <tr>
                                                ...
                                                <th class="table-info align-middle text-center" rowspan="2">Gugus</th>
                                                <th class="table-info align-middle text-center" rowspan="1" colspan="<?= count($list_month); ?>">Bulan</th>
                                            ...
                                            <?php if (isset($dtdetail)) {
                                                ...
                                                foreach ($dtdetail as $dtdetail_row) { ?>
                                                    <tr>
                                                        ...
                                                        <td align="center"><?= $dtdetail_row->gugus ?></td>

                                                        <?php if (isset($list_month)) {
                                                            foreach ($list_month as $list_month_row) { ?>
                                                                <td align="center" <?php if (isset($dtdetail_row->children)) {
